 ...
 */
public final class EMFCompareEditMessages {
	/** Fully qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.emf.compare.internal.edit_messages"; //$NON-NLS-1$
	 ...
	 */
	private EMFCompareEditMessages() {
