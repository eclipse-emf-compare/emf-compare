...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.ResourceLocationChange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceLocationChangeItemProvider extends DiffItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource, IItemColorProvider, IItemFontProvider {
	...
	protected void addBaseLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_ResourceLocationChange_baseLocation_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ResourceLocationChange_baseLocation_feature", "_UI_ResourceLocationChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ComparePackage.Literals.RESOURCE_LOCATION_CHANGE__BASE_LOCATION, true, false, false,
	...
	protected void addChangedLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_ResourceLocationChange_changedLocation_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_ResourceLocationChange_changedLocation_feature", "_UI_ResourceLocationChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						ComparePackage.Literals.RESOURCE_LOCATION_CHANGE__CHANGED_LOCATION, true, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ResourceLocationChange")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ResourceLocationChange_type") : //$NON-NLS-1$
				getString("_UI_ResourceLocationChange_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
