...
public class MoveModelElementImpl extends UpdateModelElementImpl implements
		...
		if (leftParent != null && leftParent.eIsProxy()) {
			...
			if (leftParent != oldLeftParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiffPackage.MOVE_MODEL_ELEMENT__LEFT_PARENT, oldLeftParent, leftParent));
			}
		}
		return leftParent;
	}
	...
	public void setLeftParent(EObject newLeftParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffPackage.MOVE_MODEL_ELEMENT__LEFT_PARENT, oldLeftParent, leftParent));
	}
	...
	public EObject getRightParent() {
		if (rightParent != null && rightParent.eIsProxy()) {
			...
			if (rightParent != oldRightParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DiffPackage.MOVE_MODEL_ELEMENT__RIGHT_PARENT, oldRightParent, rightParent));
			}
		}
		return rightParent;
	}
	...
	public void setRightParent(EObject newRightParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffPackage.MOVE_MODEL_ELEMENT__RIGHT_PARENT, oldRightParent, rightParent));
	}
