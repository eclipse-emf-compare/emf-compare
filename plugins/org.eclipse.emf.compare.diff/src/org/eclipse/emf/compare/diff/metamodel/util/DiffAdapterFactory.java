...
/**
 * <!-- begin-user-doc --> The <b>Adapter Factory</b> for the model. It provides an adapter <code>createXXX</code> method for each class of the
 * model. <!-- end-user-doc -->
...
public class DiffAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * if the object is either the model's package or is an instance object of the model. <!-- end-user-doc -->
	...
	protected DiffSwitch modelSwitch = new DiffSwitch() {
		...
		public Object caseRemoteRemoveModelElement(
		...
		public Object caseAttributeChangeLeftTarget(
		...
		public Object caseReferenceChangeLeftTarget(
	...
	/**
	 * Check wether this element should be visible or not. A diff element may
	 * not be visible when it's hidden by any diff extension and this diff
	 * extension is not collapsed.
	 * 
	 * @param element
	 *            :the diff element we want to know if it's visible or not.
	 * @return : true if the element should be hidden in the compare view, false
	 *         otherwhise.
	 */
	public static boolean shouldBeHidden(EObject element) {
		...
		if (element instanceof DiffElement) {
			...
			while (it.hasNext()) {
				AbstractDiffExtension extension = (AbstractDiffExtension) it
						.next();
