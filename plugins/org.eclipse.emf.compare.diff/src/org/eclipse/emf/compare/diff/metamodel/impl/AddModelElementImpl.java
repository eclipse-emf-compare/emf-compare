 ...
 * </copyright>
 *
 * $Id: AddModelElementImpl.java,v 1.1 2007/06/22 12:59:47 cbrun Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.diff.metamodel.impl.AddModelElementImpl#getLeftParent <em>Left Parent</em>}</li>
 *   <li>{@link org.eclipse.emf.compare.diff.metamodel.impl.AddModelElementImpl#getRightElement <em>Right Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AddModelElementImpl extends ModelElementChangeImpl implements AddModelElement {
	/**
			...
			if (leftParent != oldLeftParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffPackage.ADD_MODEL_ELEMENT__LEFT_PARENT, oldLeftParent, leftParent));
			}
		}
		return leftParent;
	}
	...
	public void setLeftParent(EObject newLeftParent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiffPackage.ADD_MODEL_ELEMENT__LEFT_PARENT,
	...
	public EObject getRightElement() {
		if (rightElement != null && rightElement.eIsProxy()) {
			...
			if (rightElement != oldRightElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffPackage.ADD_MODEL_ELEMENT__RIGHT_ELEMENT, oldRightElement, rightElement));
			}
		}
		return rightElement;
	}
