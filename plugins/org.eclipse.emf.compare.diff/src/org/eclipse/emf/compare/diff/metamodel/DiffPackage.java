...
public interface DiffPackage extends EPackage {
	...
	/**
	 * The meta object id for the '<em>Abstract Merger</em>' data type. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	int GENERIC_DIFF_ELEMENT_FEATURE_COUNT = DIFF_ELEMENT_FEATURE_COUNT + 0;
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em>Abstract Merger</em>' data type. <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * 
		 * @see org.eclipse.emf.compare.diff.merge.api.AbstractMerger
		 * @see org.eclipse.emf.compare.diff.metamodel.impl.DiffPackageImpl#getAbstractMerger()
