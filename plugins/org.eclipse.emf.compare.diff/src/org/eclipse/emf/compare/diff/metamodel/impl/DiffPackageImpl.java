...
public class DiffPackageImpl extends EPackageImpl implements DiffPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(abstractDiffExtensionEClass, theEcorePackage.getEBoolean(), "providesMerger", 0, 1);

		EOperation op = addEOperation(abstractDiffExtensionEClass, null, "visit");
		addEParameter(op, this.getDiffModel(), "diffModel", 0, 1);

		addEOperation(abstractDiffExtensionEClass, this.getAbstractMerger(), "getMerger", 0, 1);
		...
		initEDataType(abstractMergerEDataType, AbstractMerger.class, "AbstractMerger", IS_SERIALIZABLE,
				!IS_GENERATED_INSTANCE_CLASS);
