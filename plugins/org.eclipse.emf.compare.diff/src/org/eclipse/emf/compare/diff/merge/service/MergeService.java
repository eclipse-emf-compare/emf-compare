...
public final class MergeService {
    ...
    /**
     * Holds a list of all the merge listeners registered for notifications on
     * merge operations.
     */
    ...
    /**
     * Browse the diff model from the leaf to the top to find the containing
     * {@link DiffModel} instance.
     * 
     * @param diff
    ...
    /**
     * Merges a single DiffElement in the direction specified by
     ...
     *            left to the right model, <code>False</code> when they have
     *            to be applied the other way around.
     */
    ...
    /**
     * removes a merge listener from the list of registered listeners. This will
     * have no effect if the given listener is not registered for notifications
     * on this service.
     * 
     * @param listener
     *            New Listener to register for notifications.
    ...
    /**
     * Notifies all registered listeners that a {@link DiffElement} has just
     * been merged.
     * 
     * @param diff
    ...
    /**
     * Notifies all registered listeners that a DiffElement is about to be
     * merged.
     * 
     * @param diff
    ...
    /**
     * Notifies all registered listeners that a merge operation on a single diff
     * just ended.
     * 
     * @param diff
     *            {@link DiffElement} which has just been merged.
    ...
    /**
     * Notifies all registered listeners that a merge operation has ended for a
     * list of differences.
     * 
     * @param diffs
    ...
    /**
     * Notifies all registered listeners that a merge operation is about to
     * start for a single diff.
     * 
     * @param diff
     *            {@link DiffElement} which is about to be merged.
     */
    ...
    /**
     * Notifies all registered listeners that a merge operation is about to
     * start for a list of differences.
     * 
     * @param diffs
