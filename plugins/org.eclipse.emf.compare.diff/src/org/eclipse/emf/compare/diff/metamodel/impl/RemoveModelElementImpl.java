 ...
 * </copyright>
 *
 * $Id: RemoveModelElementImpl.java,v 1.1 2007/06/22 12:59:47 cbrun Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.diff.metamodel.impl.RemoveModelElementImpl#getRightParent <em>Right Parent</em>}</li>
 *   <li>{@link org.eclipse.emf.compare.diff.metamodel.impl.RemoveModelElementImpl#getLeftElement <em>Left Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RemoveModelElementImpl extends ModelElementChangeImpl implements RemoveModelElement {
	/**
			...
			if (rightParent != oldRightParent) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffPackage.REMOVE_MODEL_ELEMENT__RIGHT_PARENT, oldRightParent, rightParent));
			}
		}
		return rightParent;
	}
	...
	public EObject getLeftElement() {
		if (leftElement != null && leftElement.eIsProxy()) {
			...
			if (leftElement != oldLeftElement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							DiffPackage.REMOVE_MODEL_ELEMENT__LEFT_ELEMENT, oldLeftElement, leftElement));
			}
		}
		return leftElement;
	}
