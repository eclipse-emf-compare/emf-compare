...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>uml2diff</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class Uml2diffExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.uml2diff")); //$NON-NLS-1$
				UMLAssociationChange root = Uml2diffFactory.eINSTANCE.createUMLAssociationChange();
