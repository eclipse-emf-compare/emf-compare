 ...
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.SysMLStereotypeReferenceChangeRightTarget} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SysMLStereotypeReferenceChangeRightTargetItemProvider extends ReferenceChangeRightTargetItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public SysMLStereotypeReferenceChangeRightTargetItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SysMLStereotypeReferenceChangeRightTarget.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated not
	 */
	...
	public String getText(Object object) {
		...
		if (operation.isRemote())
			return getString(
					"_UI_RemoteAddUMLStereotypeReferenceValue_type", new Object[] {valueLabel, referenceLabel, //$NON-NLS-1$
							elementLabel,});
		return getString(
				"_UI_RemoveUMLStereotypeReferenceValue_type", new Object[] {valueLabel, referenceLabel, //$NON-NLS-1$
						elementLabel,});
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SysMLStereotypeReferenceChangeRightTarget.class)) {
