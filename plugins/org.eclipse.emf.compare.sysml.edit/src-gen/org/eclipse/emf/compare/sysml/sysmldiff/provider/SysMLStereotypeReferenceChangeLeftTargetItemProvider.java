...
import org.eclipse.emf.compare.diff.provider.ReferenceChangeLeftTargetItemProvider;
 ...
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.SysMLStereotypeReferenceChangeLeftTarget} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SysMLStereotypeReferenceChangeLeftTargetItemProvider extends ReferenceChangeLeftTargetItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public SysMLStereotypeReferenceChangeLeftTargetItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SysMLStereotypeReferenceChangeLeftTarget.gif. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated not
	 */
	...
	public String getText(Object object) {
		...
		if (operation.isRemote())
			return getString(
					"_UI_RemoteRemoveUMLStereotypeReferenceValue_type", new Object[] {valueLabel, referenceLabel, //$NON-NLS-1$
							elementLabel,});
		return getString("_UI_AddUMLStereotypeReferenceValue_type", new Object[] {valueLabel, referenceLabel, //$NON-NLS-1$
				elementLabel,});
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SysMLStereotypeReferenceChangeLeftTarget.class)) {
