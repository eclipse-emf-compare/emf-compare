 ...
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.SysMLStereotypeUpdateAttribute} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SysMLStereotypeUpdateAttributeItemProvider extends UpdateAttributeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public SysMLStereotypeUpdateAttributeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SysMLStereotypeUpdateAttribute.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated not
	 */
	@Override
	...
	public String getText(Object object) {
		final SysMLStereotypeUpdateAttribute updateOp = (SysMLStereotypeUpdateAttribute)object;
		...
		final Object leftValue = UMLUtil.getTaggedValue(leftElement, updateOp.getStereotype()
				.getQualifiedName(), updateOp.getAttribute().getName());
		final Object rightValue = UMLUtil.getTaggedValue(rightElement, updateOp.getStereotype()
				.getQualifiedName(), updateOp.getAttribute().getName());

		final String diffLabel;
		if (updateOp.isRemote()) {
			diffLabel = getString(
					"_UI_UMLRemoteStereotypeUpdateAttribute_type", new Object[] {attributeLabel, //$NON-NLS-1$
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SysMLStereotypeUpdateAttribute.class)) {
