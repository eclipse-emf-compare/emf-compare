...
import org.eclipse.emf.compare.diff.provider.ReferenceOrderChangeItemProvider;
 ...
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.SysMLStereotypeReferenceOrderChange} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SysMLStereotypeReferenceOrderChangeItemProvider extends ReferenceOrderChangeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public SysMLStereotypeReferenceOrderChangeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SysMLStereotypeReferenceOrderChange.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated not
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return getString(
				"_UI_StereotypeReferenceOrderChange_type", new Object[] {referenceOrderChange.getReference().getName()}); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SysMLStereotypeReferenceOrderChange.class)) {
