 ...
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.SysMLStereotypePropertyChangeLeftTarget} object. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class SysMLStereotypePropertyChangeLeftTargetItemProvider extends AttributeChangeLeftTargetItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	 ...
	 * @generated
	 */
	public SysMLStereotypePropertyChangeLeftTargetItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns SysMLStereotypePropertyChangeLeftTarget.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated not
	 */
	@Override
	...
	public String getText(Object object) {
		...
		if (operation.isRemote())
			return getString(
					"_UI_RemoteRemoveUMLStereotypeAttribute_type", new Object[] {operation.getLeftTarget(), //$NON-NLS-1$
							attributeLabel, elementLabel,});
		return getString("_UI_AddUMLStereotypeAttribute_type", new Object[] {operation.getLeftTarget(), //$NON-NLS-1$
				attributeLabel, elementLabel,});
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(SysMLStereotypePropertyChangeLeftTarget.class)) {
