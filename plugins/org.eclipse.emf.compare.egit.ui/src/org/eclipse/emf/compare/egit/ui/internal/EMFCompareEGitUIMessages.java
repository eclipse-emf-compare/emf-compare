 ...
 *******************************************************************************/
package org.eclipse.emf.compare.egit.ui.internal;
 ...
 */
public final class EMFCompareEGitUIMessages {
	/** Fully qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.emf.compare.egit.ui.internal.egit_ide_ui_messages"; //$NON-NLS-1$
	 ...
	 */
	private EMFCompareEGitUIMessages() {
