...
/**
 * This is the action bar contributor for the Addressbook model editor. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class AddressbookActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	/**
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(AddressbookEditPlugin.INSTANCE
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(AddressbookEditPlugin.INSTANCE
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(AddressbookEditPlugin.INSTANCE
				.getString("_UI_AddressbookEditor_menu"),
				"org.eclipse.emf.compare.examples.addressbook.addressbookMenuID");
		...
		//
		createChildMenuManager = new MenuManager(AddressbookEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(AddressbookEditPlugin.INSTANCE
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		submenuManager = new MenuManager(AddressbookEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item"));
