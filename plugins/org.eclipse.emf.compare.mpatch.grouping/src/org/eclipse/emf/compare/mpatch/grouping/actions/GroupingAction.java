 ...
 *******************************************************************************/
package org.eclipse.emf.compare.mpatch.grouping.actions;
...
import org.eclipse.emf.compare.mpatch.grouping.GroupingActivator;
import org.eclipse.emf.compare.mpatch.grouping.impl.DefaultMPatchGrouping;
...
public class GroupingAction extends AbstractCompareAction {
	...
	protected Status runAction(Resource input, Resource output, IProgressMonitor monitor) {
		...
		return new Status(code, GroupingActivator.PLUGIN_ID, message, exception);
	}
}
