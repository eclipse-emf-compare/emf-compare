...
if [[ "$simrel" == "collaborative-modeling"* ]]; then
	...
	simrel_zip_name="eclipse-SDK-4.5M7-${PLATFORM_SHORT_SPECIFIER}.${FILE_EXT}"
	simrel_zip_url="http://download.eclipse.org/eclipse/downloads/drops4/S-4.5M7-201504301445/$simrel_zip_name"	
