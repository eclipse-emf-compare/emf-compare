...
public class EpatchFactoryImpl extends EFactoryImpl implements EpatchFactory {
	...
	public static EpatchFactory init() {
		try {
			EpatchFactory theEpatchFactory = (EpatchFactory)EPackage.Registry.INSTANCE
					.getEFactory("http://www.eclipse.org/emf/compare/epatch/0.1");
