...
public class EpatchFactoryImpl extends EFactoryImpl implements EpatchFactory
{
  ...
  public EObject create(EClass eClass)
  {
    switch (eClass.getClassifierID())
    {
      ...
      case EpatchPackage.IMPORT: return createImport();
      ...
      case EpatchPackage.JAVA_IMPORT: return createJavaImport();
      case EpatchPackage.EXTENSION_IMPORT: return createExtensionImport();
