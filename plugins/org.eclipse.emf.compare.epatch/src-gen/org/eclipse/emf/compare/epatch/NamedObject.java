...
public interface NamedObject extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.compare.epatch.NamedObject#getName <em>Name</em>}'
	...
	/**
	 * Returns the value of the '<em><b>Assignments</b></em>' containment reference list. The list contents
	 * are of type {@link org.eclipse.emf.compare.epatch.Assignment}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Assignments</em>' containment reference list isn't clear, there really
