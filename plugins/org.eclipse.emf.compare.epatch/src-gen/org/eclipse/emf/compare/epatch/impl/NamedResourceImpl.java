...
public class NamedResourceImpl extends EObjectImpl implements NamedResource {
	...
	protected EClass eStaticClass() {
		return EpatchPackage.Literals.NAMED_RESOURCE;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EpatchPackage.NAMED_RESOURCE__LEFT_ROOT:
				return basicSetLeftRoot(null, msgs);
			case EpatchPackage.NAMED_RESOURCE__RIGHT_ROOT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EpatchPackage.NAMED_RESOURCE__NAME:
				return getName();
			case EpatchPackage.NAMED_RESOURCE__LEFT_URI:
				return getLeftUri();
			case EpatchPackage.NAMED_RESOURCE__LEFT_ROOT:
				return getLeftRoot();
			case EpatchPackage.NAMED_RESOURCE__RIGHT_URI:
				return getRightUri();
			case EpatchPackage.NAMED_RESOURCE__RIGHT_ROOT:
				return getRightRoot();
		}
