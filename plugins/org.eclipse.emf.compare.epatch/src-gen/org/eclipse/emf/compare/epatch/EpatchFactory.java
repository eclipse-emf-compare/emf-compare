...
public interface EpatchFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Extension Import</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Single Assignment</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Assignment Value</em>'. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
