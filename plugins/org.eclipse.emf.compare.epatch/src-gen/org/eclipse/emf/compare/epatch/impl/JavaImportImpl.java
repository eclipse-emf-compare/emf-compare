...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Java Import</b></em>'. <!--
 * end-user-doc -->
 * <p>
...
public class JavaImportImpl extends ImportImpl implements JavaImport {
	...
	protected EClass eStaticClass() {
		return EpatchPackage.Literals.JAVA_IMPORT;
	}
	...
	public EList<String> getPath() {
		if (path == null) {
			path = new EDataTypeEList<String>(String.class, this, EpatchPackage.JAVA_IMPORT__PATH);
		}
		return path;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EpatchPackage.JAVA_IMPORT__PATH:
				return getPath();
		}
