		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DependencyChange_dependency_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_DependencyChange_dependency_feature", "_UI_DependencyChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UMLComparePackage.Literals.DEPENDENCY_CHANGE__DEPENDENCY,
				 true,
				 false,
				 true,
				 null,
