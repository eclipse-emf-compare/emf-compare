...
public class GeneralizationSetChangeItemProvider
	 ...
	 * @generated
	 */
	public GeneralizationSetChangeItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GeneralizationSetChange_generalizationSet_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_GeneralizationSetChange_generalizationSet_feature", "_UI_GeneralizationSetChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UMLComparePackage.Literals.GENERALIZATION_SET_CHANGE__GENERALIZATION_SET,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns GeneralizationSetChange.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/GeneralizationSetChange")); //$NON-NLS-1$
	}
