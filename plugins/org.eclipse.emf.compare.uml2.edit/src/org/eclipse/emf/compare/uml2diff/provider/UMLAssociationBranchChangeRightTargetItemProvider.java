...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.uml2diff.UMLAssociationBranchChangeRightTarget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLAssociationBranchChangeRightTargetItemProvider
	 ...
	 * @generated
	 */
	public UMLAssociationBranchChangeRightTargetItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UMLAssociationBranchChangeRightTarget.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		...
		if (operation.isRemote()) {
			diffLabel = getString("_UI_RemoteAddAssociationBranch_type", new Object[] {targetName }); //$NON-NLS-1$
		} else {
			if (operation.isConflicting()) {
				diffLabel = getString("_UI_RemoveAssociationBranch_conflicting", new Object[] {targetName }); //$NON-NLS-1$
			} else {
				diffLabel = getString("_UI_RemoveAssociationBranch_type", new Object[] {targetName, }); //$NON-NLS-1$
			}
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UMLAssociationBranchChangeRightTarget.class)) {
