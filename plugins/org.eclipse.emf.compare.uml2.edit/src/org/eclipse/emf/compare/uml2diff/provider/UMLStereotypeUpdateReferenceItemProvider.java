...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.uml2diff.UMLStereotypeUpdateReference} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLStereotypeUpdateReferenceItemProvider
	extends UpdateReferenceItemProvider
	implements
	...
	/**
	 * This returns UMLStereotypeUpdateReference.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		...
		if (operation.isRemote()) {
			...
			if (operation.isConflicting()) {
				diffLabel = getString("_UI_UpdateStereotypeReference_conflicting", new Object[] {referenceLabel, //$NON-NLS-1$
						elementLabel, rightValueLabel, leftValueLabel, });
			} else {
				diffLabel = getString("_UI_UpdateStereotypeReference_type", new Object[] {referenceLabel, elementLabel, //$NON-NLS-1$
