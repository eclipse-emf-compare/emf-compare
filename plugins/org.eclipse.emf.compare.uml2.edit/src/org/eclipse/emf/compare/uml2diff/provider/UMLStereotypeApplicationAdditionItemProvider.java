...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.uml2diff.UMLStereotypeApplicationAddition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLStereotypeApplicationAdditionItemProvider
	 ...
	 * @generated
	 */
	public UMLStereotypeApplicationAdditionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addStereotypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UMLStereotypeApplicationChange_stereotype_feature"), //$NON-NLS-1$
				 getString("_UI_PropertyDescriptor_description", "_UI_UMLStereotypeApplicationChange_stereotype_feature", "_UI_UMLStereotypeApplicationChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 UML2DiffPackage.Literals.UML_STEREOTYPE_APPLICATION_CHANGE__STEREOTYPE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns UMLStereotypeApplicationAddition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		UMLStereotypeApplicationAddition umlStereotypeApplicationAddition = (UMLStereotypeApplicationAddition)object;
		
		final String stereotypeLabel = AdapterUtils.getItemProviderText(umlStereotypeApplicationAddition.getStereotype());
		final String elementLabel = AdapterUtils.getItemProviderText(umlStereotypeApplicationAddition.getRightElement());
		
		return getString("_UI_UMLStereotypeApplicationAddition_type", new Object[] {stereotypeLabel, elementLabel, });//$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UMLStereotypeApplicationAddition.class)) {
