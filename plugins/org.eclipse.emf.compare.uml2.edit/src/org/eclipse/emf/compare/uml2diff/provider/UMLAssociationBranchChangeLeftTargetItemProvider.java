...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.uml2diff.UMLAssociationBranchChangeLeftTarget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UMLAssociationBranchChangeLeftTargetItemProvider
	 ...
	 * @generated
	 */
	public UMLAssociationBranchChangeLeftTargetItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns UMLAssociationBranchChangeLeftTarget.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public String getText(Object object) {
		...
		if (operation.isRemote()) {
			if (operation.isConflicting()) {
				diffLabel = getString("_UI_RemoteRemoveAssociationBranch_conflicting", new Object[] {targetName }); //$NON-NLS-1$
			} else {
				diffLabel = getString("_UI_RemoteRemoveAssociationBranch_type", new Object[] {targetName }); //$NON-NLS-1$
			}
		} else {
			diffLabel = getString("_UI_AddAssociationBranch_type", new Object[] {targetName, }); //$NON-NLS-1$
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UMLAssociationBranchChangeLeftTarget.class)) {
