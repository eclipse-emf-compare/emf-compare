...
public class SingleStructuralFeatureAccessorFactory extends AbstractAccessorFactory {
	...
	public ITypedElement createLeft(AdapterFactory adapterFactory, Object target) {
		return new SingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.LEFT);
	}
	...
	public ITypedElement createRight(AdapterFactory adapterFactory, Object target) {
		return new SingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.RIGHT);
	}
	...
	public ITypedElement createAncestor(AdapterFactory adapterFactory, Object target) {
		return new SingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.ANCESTOR);
	}
