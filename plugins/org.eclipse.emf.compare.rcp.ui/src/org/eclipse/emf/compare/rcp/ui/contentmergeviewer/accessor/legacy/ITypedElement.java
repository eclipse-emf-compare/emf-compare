 ...
 * <p>
 * These methods are typically used to present an input object in the compare UI (<code>getName</code> and
...
public interface ITypedElement {
	...
	/**
	 * Returns the type of this object. For objects with a file name this is typically the file extension. For
	 * folders its the constant <code>FOLDER_TYPE</code>. The type is used for determining a suitable viewer
	 * for this object.
	 * 
