 ...
 */
public class IDEManyStructuralFeatureAccessorFactory extends AbstractAccessorFactory {
	...
	public ITypedElement createLeft(AdapterFactory adapterFactory, Object target) {
		return new IDEManyStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.LEFT);
	}
	...
	public ITypedElement createRight(AdapterFactory adapterFactory, Object target) {
		return new IDEManyStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.RIGHT);
	}
	...
	public ITypedElement createAncestor(AdapterFactory adapterFactory, Object target) {
		return new IDEManyStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.ANCESTOR);
	}
