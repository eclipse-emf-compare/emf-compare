 ...
 */
public class IDESingleStructuralFeatureAccessorFactory extends AbstractAccessorFactory {
	...
	public ITypedElement createLeft(AdapterFactory adapterFactory, Object target) {
		return new IDESingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.LEFT);
	}
	...
	public ITypedElement createRight(AdapterFactory adapterFactory, Object target) {
		return new IDESingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.RIGHT);
	}
	...
	public ITypedElement createAncestor(AdapterFactory adapterFactory, Object target) {
		return new IDESingleStructuralFeatureAccessorImpl((Diff)target, MergeViewerSide.ANCESTOR);
	}
