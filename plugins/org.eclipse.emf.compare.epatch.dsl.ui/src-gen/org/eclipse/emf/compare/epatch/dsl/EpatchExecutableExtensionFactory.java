 ...
 * generated
 */
public class EpatchExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {

	private Logger log = Logger.getLogger(EpatchExecutableExtensionFactory.class);
	...
	public Object create() throws CoreException {
		...
		try {
			...
			return org.eclipse.emf.compare.epatch.dsl.internal.EpatchActivator.getInstance().getInjector(
					"org.eclipse.emf.compare.epatch.dsl.Epatch").getInstance(class1);
		} catch (Exception e) {
			log.error(e);
