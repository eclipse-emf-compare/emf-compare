...
public final class ModelUtils {
 ...
 // TODO unit test this
    ...
    /**
     * Loads a model from an {@link org.eclipse.core.resources.IFile IFile} in a
    ...
    public static EObject load(IFile file, ResourceSet resourceSet) throws IOException {
        ...
        final Resource modelResource = createResource(URI.createPlatformResourceURI(file.getFullPath().toOSString(), true), resourceSet);
