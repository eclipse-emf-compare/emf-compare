...
public final class EFactory {
	...
	/**
	 * This will call the method called <code>name</code> on the given <code>object</code> with the given <code>arg</code>uments.
	 * 
	 * @param object
	...
	/**
	 * Removes the value of the given feature of the object. If the structural feature isn't a list, it behaves like eSet(object, name, null).
	 * 
	 * @param object
	 ...
	 * @param name
	 *            The feature name, or a method defined on {@link EObject} like 'eClass', 'eResource', 'eContainer', 'eContainingFeature',
	 *            'eContainmentFeature', 'eContents', 'eAllContents', 'eCrossReferences'
	...
	public static EStructuralFeature eStructuralFeature(EObject object, String name) throws FactoryException {
		...
		throw new FactoryException(Messages.getString("EFactory.FeatureNotFound", name, object.eClass().getName())); //$NON-NLS-1$
	}
