...
import org.eclipse.emf.compare.diagram.diagramdiff.impl.BusinessDiagramShowElementImpl;
import org.eclipse.emf.compare.diff.metamodel.AbstractDiffExtension;
import org.eclipse.emf.compare.diff.metamodel.DiffElement;
import org.eclipse.emf.compare.diff.metamodel.DiffGroup;

/**
 * The factory for the DiagramShowElement extensions.
 * 
...
public class DiagramShowElementFactory extends AbstractDiffExtensionFactory {
	...
	public boolean handles(DiffElement input, DiffGroup root) {
		return BusinessDiagramShowElementImpl.isConcernedBy(input);
	}
	...
	protected AbstractDiffExtension init() {
		return DiagramdiffFactory.eINSTANCE.createDiagramShowElement();
	}
