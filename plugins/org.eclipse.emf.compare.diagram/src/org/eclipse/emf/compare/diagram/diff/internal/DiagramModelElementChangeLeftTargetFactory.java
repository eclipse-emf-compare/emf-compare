...
import org.eclipse.emf.compare.diagram.diagramdiff.impl.BusinessDiagramModelElementChangeLeftTargetImpl;
...
/**
 * The factory for the DiagramModelElementChangeLeftTarget extensions.
 * 
...
public class DiagramModelElementChangeLeftTargetFactory extends AbstractDiffExtensionFactory {
	 ...
	 *            The match model.
	 */
	public DiagramModelElementChangeLeftTargetFactory(EcoreUtil.CrossReferencer crossReferencer,
			MatchModel match) {
	...
	public boolean handles(DiffElement input, DiffGroup root) {
		return BusinessDiagramModelElementChangeLeftTargetImpl.isConcernedBy(input);
	}
	...
	protected AbstractDiffExtension init() {
		return DiagramdiffFactory.eINSTANCE.createDiagramModelElementChangeLeftTarget();
	}
