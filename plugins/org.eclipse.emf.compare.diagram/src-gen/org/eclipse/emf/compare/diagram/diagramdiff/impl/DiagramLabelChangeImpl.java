...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diagram Label Change</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.diagram.diagramdiff.impl.DiagramLabelChangeImpl#getHideElements <em>Hide Elements</em>}</li>
 *   <li>{@link org.eclipse.emf.compare.diagram.diagramdiff.impl.DiagramLabelChangeImpl#isIsCollapsed <em>Is Collapsed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DiagramLabelChangeImpl extends UpdateModelElementImpl implements DiagramLabelChange {
	/**
	 ...
	 * @generated
	 */
	protected DiagramLabelChangeImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DiagramdiffPackage.Literals.DIAGRAM_LABEL_CHANGE;
	}
	...
	public EList<DiffElement> getHideElements() {
		if (hideElements == null) {
			hideElements = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class, this, DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__HIDE_ELEMENTS, DiffPackage.DIFF_ELEMENT__IS_HIDDEN_BY);
		}
		return hideElements;
	}
	...
	public void setIsCollapsed(boolean newIsCollapsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__IS_COLLAPSED, oldIsCollapsed, isCollapsed));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__HIDE_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__IS_COLLAPSED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDiffExtension.class) {
			switch (derivedFeatureID) {
				case DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__HIDE_ELEMENTS: return DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS;
				case DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__IS_COLLAPSED: return DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDiffExtension.class) {
			switch (baseFeatureID) {
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS: return DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__HIDE_ELEMENTS;
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED: return DiagramdiffPackage.DIAGRAM_LABEL_CHANGE__IS_COLLAPSED;
				default: return -1;
			}
		}
		if (baseClass == DiagramDiffExtension.class) {
