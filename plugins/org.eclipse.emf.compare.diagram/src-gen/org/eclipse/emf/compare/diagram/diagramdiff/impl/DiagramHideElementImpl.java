...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Diagram Hide Element</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.diagram.diagramdiff.impl.DiagramHideElementImpl#getHideElements <em>Hide Elements</em>}</li>
 *   <li>{@link org.eclipse.emf.compare.diagram.diagramdiff.impl.DiagramHideElementImpl#isIsCollapsed <em>Is Collapsed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class DiagramHideElementImpl extends UpdateModelElementImpl implements DiagramHideElement {
	/**
	 ...
	 * @generated
	 */
	protected DiagramHideElementImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DiagramdiffPackage.Literals.DIAGRAM_HIDE_ELEMENT;
	}
	...
	public EList<DiffElement> getHideElements() {
		if (hideElements == null) {
			hideElements = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class, this, DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__HIDE_ELEMENTS, DiffPackage.DIFF_ELEMENT__IS_HIDDEN_BY);
		}
		return hideElements;
	}
	...
	public void setIsCollapsed(boolean newIsCollapsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__IS_COLLAPSED, oldIsCollapsed, isCollapsed));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__HIDE_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__IS_COLLAPSED:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDiffExtension.class) {
			switch (derivedFeatureID) {
				case DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__HIDE_ELEMENTS: return DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS;
				case DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__IS_COLLAPSED: return DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == AbstractDiffExtension.class) {
			switch (baseFeatureID) {
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS: return DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__HIDE_ELEMENTS;
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED: return DiagramdiffPackage.DIAGRAM_HIDE_ELEMENT__IS_COLLAPSED;
				default: return -1;
			}
		}
		if (baseClass == DiagramDiffExtension.class) {
