 ...
 * <em><b>UML Stereotype Update Attribute</b></em>'. <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.eclipse.emf.compare.uml2diff.impl.UMLStereotypeUpdateAttributeImpl#getStereotype <em>Stereotype</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLStereotypeUpdateAttributeImpl extends UpdateAttributeImpl implements UMLStereotypeUpdateAttribute {
	...
	public Stereotype getStereotype() {
		if (stereotype != null && stereotype.eIsProxy()) {
			...
			if (stereotype != oldStereotype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UML2DiffPackage.UML_STEREOTYPE_UPDATE_ATTRIBUTE__STEREOTYPE, oldStereotype, stereotype));
			}
		}
		return stereotype;
	}
	...
	public void setStereotype(Stereotype newStereotype) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UML2DiffPackage.UML_STEREOTYPE_UPDATE_ATTRIBUTE__STEREOTYPE, oldStereotype, stereotype));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2DiffPackage.UML_STEREOTYPE_UPDATE_ATTRIBUTE__STEREOTYPE:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == UMLStereotypePropertyChange.class) {
			switch (derivedFeatureID) {
				case UML2DiffPackage.UML_STEREOTYPE_UPDATE_ATTRIBUTE__STEREOTYPE: return UML2DiffPackage.UML_STEREOTYPE_PROPERTY_CHANGE__STEREOTYPE;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == UMLStereotypePropertyChange.class) {
			switch (baseFeatureID) {
				case UML2DiffPackage.UML_STEREOTYPE_PROPERTY_CHANGE__STEREOTYPE: return UML2DiffPackage.UML_STEREOTYPE_UPDATE_ATTRIBUTE__STEREOTYPE;
				default: return -1;
			}
		}
