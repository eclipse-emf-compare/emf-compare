 ...
 * <ul>
 * <li>{@link org.eclipse.emf.compare.uml2diff.impl.UMLDestructionEventChangeLeftTargetImpl#getHideElements
 * <em>Hide Elements</em>}</li>
 * <li>{@link org.eclipse.emf.compare.uml2diff.impl.UMLDestructionEventChangeLeftTargetImpl#isIsCollapsed <em>
 * Is Collapsed</em>}</li>
 * </ul>
 * </p>
 * 
	...
	public EList<DiffElement> getHideElements() {
		if (hideElements == null) {
			hideElements = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class,
					this, UML2DiffPackage.UML_DESTRUCTION_EVENT_CHANGE_LEFT_TARGET__HIDE_ELEMENTS,
	...
	public void setIsCollapsed(boolean newIsCollapsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UML2DiffPackage.UML_DESTRUCTION_EVENT_CHANGE_LEFT_TARGET__IS_COLLAPSED, oldIsCollapsed,
					isCollapsed));
	}
		...
		if (baseClass == AbstractDiffExtension.class) {
			switch (baseFeatureID) {
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS:
					return UML2DiffPackage.UML_DESTRUCTION_EVENT_CHANGE_LEFT_TARGET__HIDE_ELEMENTS;
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED:
					return UML2DiffPackage.UML_DESTRUCTION_EVENT_CHANGE_LEFT_TARGET__IS_COLLAPSED;
				default:
					return -1;
			}
		}
