...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>UML Stereotype Attribute Change Left Target</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link org.eclipse.emf.compare.uml2diff.impl.UMLStereotypeAttributeChangeLeftTargetImpl#getStereotypeApplications <em>Stereotype Applications</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class UMLStereotypeAttributeChangeLeftTargetImpl extends AttributeChangeLeftTargetImpl implements UMLStereotypeAttributeChangeLeftTarget {
	...
	public EList<EObject> getStereotypeApplications() {
		if (stereotypeApplications == null) {
			stereotypeApplications = new EObjectResolvingEList<EObject>(EObject.class, this, UML2DiffPackage.UML_STEREOTYPE_ATTRIBUTE_CHANGE_LEFT_TARGET__STEREOTYPE_APPLICATIONS);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case UML2DiffPackage.UML_STEREOTYPE_ATTRIBUTE_CHANGE_LEFT_TARGET__STEREOTYPE_APPLICATIONS:
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == UMLStereotypePropertyChange.class) {
			switch (derivedFeatureID) {
				case UML2DiffPackage.UML_STEREOTYPE_ATTRIBUTE_CHANGE_LEFT_TARGET__STEREOTYPE_APPLICATIONS: return UML2DiffPackage.UML_STEREOTYPE_PROPERTY_CHANGE__STEREOTYPE_APPLICATIONS;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == UMLStereotypePropertyChange.class) {
			switch (baseFeatureID) {
				case UML2DiffPackage.UML_STEREOTYPE_PROPERTY_CHANGE__STEREOTYPE_APPLICATIONS: return UML2DiffPackage.UML_STEREOTYPE_ATTRIBUTE_CHANGE_LEFT_TARGET__STEREOTYPE_APPLICATIONS;
				default: return -1;
			}
		}
