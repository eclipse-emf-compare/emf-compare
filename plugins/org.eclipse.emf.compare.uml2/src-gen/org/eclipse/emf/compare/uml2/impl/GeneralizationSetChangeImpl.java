 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.uml2.impl.GeneralizationSetChangeImpl#getGeneralizationSet <em>Generalization Set</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GeneralizationSetChangeImpl extends UMLDiffImpl implements GeneralizationSetChange {
		...
		if (generalizationSet != null && generalizationSet.eIsProxy()) {
			...
			if (generalizationSet != oldGeneralizationSet) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, UMLComparePackage.GENERALIZATION_SET_CHANGE__GENERALIZATION_SET, oldGeneralizationSet, generalizationSet));
			}
		}
	...
	public void setGeneralizationSet(GeneralizationSet newGeneralizationSet) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UMLComparePackage.GENERALIZATION_SET_CHANGE__GENERALIZATION_SET, oldGeneralizationSet, generalizationSet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UMLComparePackage.GENERALIZATION_SET_CHANGE__GENERALIZATION_SET:
