 ...
 */
public final class EMFCompareDiagramEditMessages {
	/** Fully qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.emf.compare.diagram.internal.diagram_edit_messages"; //$NON-NLS-1$
	 ...
	 */
	private EMFCompareDiagramEditMessages() {
