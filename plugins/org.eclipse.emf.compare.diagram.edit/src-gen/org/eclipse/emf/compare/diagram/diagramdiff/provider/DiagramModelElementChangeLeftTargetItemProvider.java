...
public class DiagramModelElementChangeLeftTargetItemProvider
	...
	public String getText(Object object) {
		if (object instanceof ModelElementChangeLeftTarget) {
			final ModelElementChangeLeftTarget operation = (ModelElementChangeLeftTarget)object;
			final EObject view = operation.getLeftElement();
	 ...
	 */
	private String buildMessage(ModelElementChangeLeftTarget operation, String label) {
