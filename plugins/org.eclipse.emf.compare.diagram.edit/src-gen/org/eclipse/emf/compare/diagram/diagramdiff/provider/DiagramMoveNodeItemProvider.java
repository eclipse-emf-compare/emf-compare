...
import org.eclipse.emf.compare.diff.provider.MoveModelElementItemProvider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diagram.diagramdiff.DiagramMoveNode} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramMoveNodeItemProvider
	extends MoveModelElementItemProvider
	implements
	 ...
	 * @generated
	 */
	public DiagramMoveNodeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		DiagramMoveNode diagramMoveNode = (DiagramMoveNode)object;
		return getString("_UI_DiagramMoveNode_type") + " " + diagramMoveNode.isConflicting(); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramMoveNode.class)) {
