...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diagram.diagramdiff.DiagramEdgeChange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramEdgeChangeItemProvider
	 ...
	 * @generated
	 */
	public DiagramEdgeChangeItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		DiagramEdgeChange diagramEdgeChange = (DiagramEdgeChange)object;
		return getString("_UI_DiagramEdgeChange_type") + " " + diagramEdgeChange.isConflicting(); //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DiagramEdgeChange.class)) {
