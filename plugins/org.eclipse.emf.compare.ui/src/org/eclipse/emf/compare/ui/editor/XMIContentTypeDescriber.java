...
/**
 * This class will try and determine if a given file is an xmi file. Assumes UTF-8 encoding and that an xml file starts with <tt>&quot;&lt;?xml &quot;</tt>. If these conditions are met, we seek the declaration of the xmi:version of the file.
 * 
...
public class XMIContentTypeDescriber implements ITextContentDescriber {
	...
	public int describe(InputStream input, IContentDescription description) throws IOException {
		...
		if (input.read(prefix) < prefix.length)
			...
			// Checks if has an xml declaration
