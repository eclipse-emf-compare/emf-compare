...
public class DiffNodeDecorator extends AbstractDifferenceDecorator {
	...
	protected List<IDecoration> getAddedDecorations() {
		...
		final Image added = GMFComparePlugin.getDefault().getImage(GMFComparePlugin.ICON_ADDED);
	...
	protected List<IDecoration> getRemovedDecorations() {
		...
		final Image deleted = GMFComparePlugin.getDefault().getImage(GMFComparePlugin.ICON_DELETED);
