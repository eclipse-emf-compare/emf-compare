 ...
 *
 * $Id: ChangeBindingItemProvider.java,v 1.1 2010/09/10 15:27:17 cbrun Exp $
 *******************************************************************************/
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.mpatch.binding.ChangeBinding} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ChangeBindingItemProvider
	 ...
	 * @generated
	 */
	public ChangeBindingItemProvider(AdapterFactory adapterFactory) {
	...
	protected void addChangePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ChangeBinding_change_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ChangeBinding_change_feature", "_UI_ChangeBinding_type"),
				 BindingPackage.Literals.CHANGE_BINDING__CHANGE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BindingPackage.Literals.CHANGE_BINDING__CORRESPONDING_ELEMENTS);
		}
	...
	public String getText(Object object) {
		return getString("_UI_ChangeBinding_type");
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChangeBinding.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BindingPackage.Literals.CHANGE_BINDING__CORRESPONDING_ELEMENTS,
