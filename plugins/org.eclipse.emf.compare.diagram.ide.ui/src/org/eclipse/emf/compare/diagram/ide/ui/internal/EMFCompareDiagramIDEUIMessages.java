 ...
 */
public final class EMFCompareDiagramIDEUIMessages {
	/** Fully qualified path to the properties file in which to seek the keys. */
	private static final String BUNDLE_NAME = "org.eclipse.emf.compare.diagram.ide.ui.diagram_ide_ui_messages"; //$NON-NLS-1$
	 ...
	 */
	private EMFCompareDiagramIDEUIMessages() {
