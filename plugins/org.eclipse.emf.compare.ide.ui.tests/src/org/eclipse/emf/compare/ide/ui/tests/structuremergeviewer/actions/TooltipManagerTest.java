...
public class TooltipManagerTest extends AbstractTestTreeNodeItemProviderAdapter {
	...
	public void testReject() {
		...
		action.updateSelection(new StructuredSelection(leftContainmentAdd));
		toolTipText = action.getToolTipText();
		tooltipBody = getString("reject.multiple.changes.tooltip");
	...
	public void testAccept() {
		...
		action.updateSelection(new StructuredSelection(leftContainmentAdd));
		toolTipText = action.getToolTipText();
		tooltipBody = getString("accept.multiple.changes.tooltip");
		assertEquals(tooltipBody, toolTipText);
		action.clearCache();
	}
	...
	public void testLeftToRight() {
		...
		action.updateSelection(new StructuredSelection(leftContainmentAdd));
		toolTipText = action.getToolTipText();
		tooltipBody = getString("merged.multiple.to.right.tooltip");
		assertEquals(tooltipBody, toolTipText);
		action.clearCache();
	}
	...
	public void testRightToLeft() {
		...
		action.updateSelection(new StructuredSelection(leftContainmentAdd));
		toolTipText = action.getToolTipText();
		tooltipBody = getString("merged.multiple.to.left.tooltip");
		assertEquals(tooltipBody, toolTipText);
		action.clearCache();
	}
