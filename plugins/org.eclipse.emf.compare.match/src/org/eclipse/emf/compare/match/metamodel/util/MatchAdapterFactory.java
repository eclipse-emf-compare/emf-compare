...
public class MatchAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.compare.match.metamodel.MatchElement <em>Element</em>}'. <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.compare.match.metamodel.MatchModel <em>Model</em>}'. <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
