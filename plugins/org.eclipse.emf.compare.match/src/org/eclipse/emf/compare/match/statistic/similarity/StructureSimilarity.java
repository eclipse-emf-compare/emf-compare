...
public class StructureSimilarity {
	 ...
	 * type similarities of the 2 EObjects. 
	 *  - 1 means the 2 objects types are very similar
	 *  - 0 means the 2 objects types are very differents
	 * 
	 * @param obj1
	 * @param obj2
	 * @return
	...
	/**
	 * This method returns a double comprised between 0 and 1 representing the 
	 * relations similarities of the 2 EObjects. 
	 *  - 1 means the 2 objects surround are very similar
	 *  - 0 means the 2 objects surround are very differents
	 * 
	 * @param obj1
	 * @param obj2
	 * @return
	...
	public static Collection typeValueList(EObject current)
		...
		if (eclassAttributes.size() > 0) {
			result.add("type:" + current.eClass().getName() );
	...
	/**
	 * This method returns a String with content corresponding to the EObject type
	 * 
	 * @param current
	 * @return
	 * @throws FactoryException
