...
public interface MatchElement extends EObject {
	/**
	 * Returns the value of the '<em><b>Similarity</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Returns the value of the '<em><b>Sub Match Elements</b></em>' containment reference list. The list
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.compare.match.metamodel.MatchElement#getSimilarity <em>Similarity</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Similarity</em>' attribute.
	 * @see #getSimilarity()
	 * @generated
	 */
