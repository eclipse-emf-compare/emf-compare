...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.RemoteRemoveAttribute} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
@SuppressWarnings("nls")
public class RemoteRemoveAttributeItemProvider extends RemoveAttributeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	public String getText(Object object) {
		...
		try {
			return getString("_UI_RemoteRemoveAttribute_type", new Object[] {NameSimilarity.findName(removeOp.getLeftTarget()), NameSimilarity.findName(removeOp.getAttribute()), //$NON-NLS-1$
