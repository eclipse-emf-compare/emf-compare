...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.RemoteAddModelElement} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
public class RemoteAddModelElementItemProvider extends ModelElementChangeLeftTargetItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	 ...
	 * @generated
	 */
	public RemoteAddModelElementItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns RemoteAddModelElement.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/RemoteAddModelElement")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		...
		try {
			return getString("_UI_RemoteAddModelElement_type", new Object[] {NameSimilarity.findName(addOp.getLeftElement())}); //$NON-NLS-1$
