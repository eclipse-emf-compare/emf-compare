 ...
 * @generated
 */
public class AddAttributeItemProvider extends AttributeChangeLeftTargetItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	public String getText(Object object) {
		...
		return getString("_UI_AddAttribute_type", new Object[] {addOp.getLeftTarget(), //$NON-NLS-1$
