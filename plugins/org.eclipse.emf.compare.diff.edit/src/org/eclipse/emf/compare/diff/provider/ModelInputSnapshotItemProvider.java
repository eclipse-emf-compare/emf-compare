...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.ModelInputSnapshot} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
public class ModelInputSnapshotItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addDatePropertyDescriptor(@SuppressWarnings("unused")
	Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ModelInputSnapshot_date_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ModelInputSnapshot_date_feature", "_UI_ModelInputSnapshot_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				DiffPackage.Literals.MODEL_INPUT_SNAPSHOT__DATE, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_ModelInputSnapshot_type") : getString("_UI_ModelInputSnapshot_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DiffPackage.Literals.MODEL_INPUT_SNAPSHOT__DIFF, DiffFactory.eINSTANCE.createDiffModel()));

		newChildDescriptors.add(createChildParameter(DiffPackage.Literals.MODEL_INPUT_SNAPSHOT__MATCH, MatchFactory.eINSTANCE.createMatchModel()));
	}
