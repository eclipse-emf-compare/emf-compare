...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.AttributeChangeLeftTarget} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
...
public class AttributeChangeLeftTargetItemProvider extends AttributeChangeItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_AttributeChangeLeftTarget_leftTarget_feature"), getString("_UI_PropertyDescriptor_description", "_UI_AttributeChangeLeftTarget_leftTarget_feature",
						"_UI_AttributeChangeLeftTarget_type"), DiffPackage.Literals.ATTRIBUTE_CHANGE_LEFT_TARGET__LEFT_TARGET, true, false, true, null, null, null));
	}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AttributeChangeLeftTarget"));
	}
	...
	public String getText(Object object) {
		return getString("_UI_AttributeChangeLeftTarget_type");
	}
