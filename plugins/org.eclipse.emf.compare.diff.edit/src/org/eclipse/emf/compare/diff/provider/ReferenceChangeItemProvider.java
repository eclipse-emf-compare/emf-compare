...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.ReferenceChange} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
...
public class ReferenceChangeItemProvider extends DiffElementItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	...
	protected void addReferencePropertyDescriptor(@SuppressWarnings("unused")
	Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ReferenceChange_reference_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ReferenceChange_reference_feature", "_UI_ReferenceChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
	...
	Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ReferenceChange_rightElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ReferenceChange_rightElement_feature", "_UI_ReferenceChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				DiffPackage.Literals.REFERENCE_CHANGE__RIGHT_ELEMENT, true, false, true, null, null, null));
	}
	...
	Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ReferenceChange_leftElement_feature"), getString("_UI_PropertyDescriptor_description", "_UI_ReferenceChange_leftElement_feature", "_UI_ReferenceChange_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$ //$NON-NLS-4$
				DiffPackage.Literals.REFERENCE_CHANGE__LEFT_ELEMENT, true, false, true, null, null, null));
	}
