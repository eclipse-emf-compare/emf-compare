...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.diff.metamodel.RemoteAddReferenceValue} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
@SuppressWarnings("nls")
public class RemoteAddReferenceValueItemProvider extends AddReferenceValueItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource {
	/**
	...
	public String getText(Object object) {
		...
		try {
			return getString("_UI_RemoteAddReferenceValue_type", new Object[] {NameSimilarity.findName(addOp.getRightAddedTarget()), NameSimilarity.findName(addOp.getReference()), //$NON-NLS-1$
