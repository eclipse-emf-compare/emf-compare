...
public class TestAPI  {
	...
	static final String DIAGRAM_KIND_PATH = "/diagrams/decorators";
	
	static final String MODIFIED_MODEL_UML = "/modified/TC.ecorediag";

	static final String ORIGINAL_MODEL_UML = "/original/TC.ecorediag";
	
	static final String EXPECTED_MODIFIED_MODEL_UML = "/expected" + MODIFIED_MODEL_UML;
	
	static final String EXPECTED_ORIGINAL_MODEL_UML = "/expected" + ORIGINAL_MODEL_UML;
	...
	public void testLayerDecorators1() throws IOException, InterruptedException {		
		...
		final Resource original = originalResourceSet.createResource(URI.createURI(DIAGRAM_KIND_PATH + ORIGINAL_MODEL_UML));
		original.load(
				getClass().getResourceAsStream(DIAGRAM_KIND_PATH + ORIGINAL_MODEL_UML), Collections.emptyMap());
		
		final ResourceSet modifiedResourceSet = new ResourceSetImpl();		
		final Resource modified = modifiedResourceSet.createResource(URI.createURI(DIAGRAM_KIND_PATH + MODIFIED_MODEL_UML));
		modified.load(
				getClass().getResourceAsStream(DIAGRAM_KIND_PATH + MODIFIED_MODEL_UML), Collections.emptyMap());
		...
		final Resource expectedOriginal = expectedOriginalResourceSet.createResource(URI.createURI(DIAGRAM_KIND_PATH + EXPECTED_ORIGINAL_MODEL_UML));
		expectedOriginal.load(
				getClass().getResourceAsStream(DIAGRAM_KIND_PATH + EXPECTED_ORIGINAL_MODEL_UML), Collections.emptyMap());
		
		final ResourceSet expectedModifiedResourceSet = new ResourceSetImpl();
		final Resource expectedModified = expectedModifiedResourceSet.createResource(URI.createURI(DIAGRAM_KIND_PATH + EXPECTED_MODIFIED_MODEL_UML));
		expectedModified.load(
				getClass().getResourceAsStream(DIAGRAM_KIND_PATH + EXPECTED_MODIFIED_MODEL_UML), Collections.emptyMap());
