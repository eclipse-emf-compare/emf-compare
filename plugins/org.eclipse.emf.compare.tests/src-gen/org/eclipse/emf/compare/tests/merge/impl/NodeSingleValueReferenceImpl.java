...
import org.eclipse.emf.compare.tests.merge.NodeSingleValueReference;
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.tests.merge.impl.NodeSingleValueReferenceImpl#getSingleValuedReference <em>Single Valued Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeSingleValueReferenceImpl extends NodeImpl implements NodeSingleValueReference {
	...
	protected EClass eStaticClass() {
		return MergePackage.Literals.NODE_SINGLE_VALUE_REFERENCE;
	}
		...
		if (singleValuedReference != null && singleValuedReference.eIsProxy()) {
			...
			if (singleValuedReference != oldSingleValuedReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, MergePackage.NODE_SINGLE_VALUE_REFERENCE__SINGLE_VALUED_REFERENCE, oldSingleValuedReference, singleValuedReference));
			}
		}
	...
	public void setSingleValuedReference(Node newSingleValuedReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MergePackage.NODE_SINGLE_VALUE_REFERENCE__SINGLE_VALUED_REFERENCE, oldSingleValuedReference, singleValuedReference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MergePackage.NODE_SINGLE_VALUE_REFERENCE__SINGLE_VALUED_REFERENCE:
