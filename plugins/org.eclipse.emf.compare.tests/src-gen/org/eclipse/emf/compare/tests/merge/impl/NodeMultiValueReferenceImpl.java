...
import org.eclipse.emf.compare.tests.merge.NodeMultiValueReference;
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.tests.merge.impl.NodeMultiValueReferenceImpl#getMultiValuedReference <em>Multi Valued Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NodeMultiValueReferenceImpl extends NodeImpl implements NodeMultiValueReference {
	...
	protected EClass eStaticClass() {
		return MergePackage.Literals.NODE_MULTI_VALUE_REFERENCE;
	}
	...
	public EList<Node> getMultiValuedReference() {
		if (multiValuedReference == null) {
			multiValuedReference = new EObjectResolvingEList<Node>(Node.class, this, MergePackage.NODE_MULTI_VALUE_REFERENCE__MULTI_VALUED_REFERENCE);
		}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MergePackage.NODE_MULTI_VALUE_REFERENCE__MULTI_VALUED_REFERENCE:
