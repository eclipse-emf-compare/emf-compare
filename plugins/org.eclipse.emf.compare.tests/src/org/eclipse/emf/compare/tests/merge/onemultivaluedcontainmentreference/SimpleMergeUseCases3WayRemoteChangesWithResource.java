...
public class SimpleMergeUseCases3WayRemoteChangesWithResource extends SimpleMergeUseCases {
	@Override
	protected List<DiffElement> detectDifferences(EObject left, EObject right) throws InterruptedException {
		...
		MatchModel match = MatchService.doResourceMatch(leftRes, right.eResource(), ancestorRes, options);
