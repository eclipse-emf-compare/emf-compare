...
public final class EpatchSingleAssignmentValueConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "value", false, false, getElement(),
					getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$14$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "refFeature", false, false, getElement(),
					getRuleCall$14$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$28$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(fragmentConsumer, "impFrag", false, false, getElement(),
					getRuleCall$28$Delimiter(), optional);
		}
	}

	public EpatchSingleAssignmentValueConsumer(INonTerminalConsumerConfiguration configuration,
	...
	public void setRule(SingleAssignmentValueElements rule) {
		...
		crossReference$24$Consumer = new CrossReference$24$Consumer(rule
