...
public final class EpatchEpatchConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(modelImportConsumer, "modelImports", true, false, false, getElement(), optional);
		}
	}
	...
	public EpatchEpatchConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(EpatchElements rule) {
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getModelImportsAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getModelImportsModelImportParserRuleCall_3_0());
