...
import org.eclipse.emf.compare.epatch.dsl.services.EpatchGrammarAccess.ExtensionImportElements;

public final class EpatchExtensionImportConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "path", true, false, getElement(), getRuleCall$5$Delimiter(),
					optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "path", true, false, getElement(), getRuleCall$9$Delimiter(),
					optional);
		}
	}

	public EpatchExtensionImportConsumer(INonTerminalConsumerConfiguration configuration,
