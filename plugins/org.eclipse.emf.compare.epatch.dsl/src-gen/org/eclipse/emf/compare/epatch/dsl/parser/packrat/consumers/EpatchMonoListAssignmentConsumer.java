...
public final class EpatchMonoListAssignmentConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(assignmentValueConsumer, "leftValues", true, false, false,
					getElement(), optional);
		}
	}
	...
	public EpatchMonoListAssignmentConsumer(INonTerminalConsumerConfiguration configuration,
