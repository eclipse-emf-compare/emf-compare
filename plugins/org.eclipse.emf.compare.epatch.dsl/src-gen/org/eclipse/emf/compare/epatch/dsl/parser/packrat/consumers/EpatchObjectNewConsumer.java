...
public final class EpatchObjectNewConsumer extends NonTerminalConsumer {
	...
	public EpatchObjectNewConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ObjectNewElements rule) {
		...
		crossReference$4$Consumer = new CrossReference$4$Consumer(rule.getImportModelImportCrossReference_1_0());
