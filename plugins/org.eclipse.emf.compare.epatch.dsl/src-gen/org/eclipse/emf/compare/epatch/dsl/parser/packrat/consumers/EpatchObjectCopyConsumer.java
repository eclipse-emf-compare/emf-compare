...
public final class EpatchObjectCopyConsumer extends NonTerminalConsumer {
	...
	protected class CrossReference$4$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "resource", false, false, getElement(),
					getRuleCall$6$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(fragmentConsumer, "fragment", false, false, getElement(),
	...
	protected class RuleCall$10$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "name", false, false, getElement(),
	...
	protected class RuleCall$15$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(monoSingleAssignmentConsumer, "assignments", true, false, false,
					getElement(), optional);
		}
	}
	...
	protected class RuleCall$17$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(monoListAssignmentConsumer, "assignments", true, false, false,
					getElement(), optional);
		}
	}
	...
	public EpatchObjectCopyConsumer(INonTerminalConsumerConfiguration configuration,
	...
	public void setRule(ObjectCopyElements rule) {
		...
		crossReference$4$Consumer = new CrossReference$4$Consumer(rule
		...
		ruleCall$15$Consumer = new RuleCall$15$Consumer(rule
		...
		ruleCall$17$Consumer = new RuleCall$17$Consumer(rule
