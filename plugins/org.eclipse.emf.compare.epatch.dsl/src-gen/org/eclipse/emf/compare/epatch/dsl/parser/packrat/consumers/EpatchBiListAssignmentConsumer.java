...
public final class EpatchBiListAssignmentConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(listAssignmentValueConsumer, "leftValues", true, false, false,
					getElement(), optional);
		}
	}
	...
	protected class RuleCall$16$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(listAssignmentValueConsumer, "rightValues", true, false, false,
					getElement(), optional);
		}
	}
	...
	public EpatchBiListAssignmentConsumer(INonTerminalConsumerConfiguration configuration,
	...
	public void setRule(BiListAssignmentElements rule) {
		...
		ruleCall$8$Consumer = new RuleCall$8$Consumer(rule
				.getLeftValuesListAssignmentValueParserRuleCall_3_0_0());
		...
		ruleCall$12$Consumer = new RuleCall$12$Consumer(rule
		...
		ruleCall$16$Consumer = new RuleCall$16$Consumer(rule
				.getRightValuesListAssignmentValueParserRuleCall_5_0_0());
		...
		ruleCall$20$Consumer = new RuleCall$20$Consumer(rule
