...
import org.eclipse.emf.compare.epatch.dsl.services.EpatchGrammarAccess.ResourceImportElements;

public final class EpatchResourceImportConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "uri", false, false, getElement(), getRuleCall$7$Delimiter(), optional);
		}
	}

	public EpatchResourceImportConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
