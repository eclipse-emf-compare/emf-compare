...
public final class EpatchListAssignmentValueConsumer extends NonTerminalConsumer {
	...
	public EpatchListAssignmentValueConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ListAssignmentValueElements rule) {
		...
		crossReference$31$Consumer = new CrossReference$31$Consumer(rule.getImportModelImportCrossReference_2_4_0_0());
