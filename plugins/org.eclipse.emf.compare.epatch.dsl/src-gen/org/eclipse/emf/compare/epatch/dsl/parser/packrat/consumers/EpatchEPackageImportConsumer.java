...
public final class EpatchEPackageImportConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "nsURI", false, false, getElement(),
					getRuleCall$7$Delimiter(), optional);
		}
	}

	public EpatchEPackageImportConsumer(INonTerminalConsumerConfiguration configuration,
