...
import org.eclipse.emf.compare.epatch.dsl.services.EpatchGrammarAccess.EPackageImportElements;

public final class EpatchEPackageImportConsumer extends NonTerminalConsumer {

	private EPackageImportElements rule;	
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "nsURI", false, false, getElement(), getRuleCall$7$Delimiter(), optional);
		}
	}

	public EpatchEPackageImportConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public EPackageImportElements getRule() {
		return rule;
	}
	
	public void setRule(EPackageImportElements rule) {
		this.rule = rule;
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getNsKeyword_2());
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getNsURIAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getNsURISTRINGTerminalRuleCall_3_0());
	}
