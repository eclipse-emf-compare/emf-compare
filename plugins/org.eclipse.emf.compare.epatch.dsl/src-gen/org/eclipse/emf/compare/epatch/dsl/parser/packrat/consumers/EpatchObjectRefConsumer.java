...
public final class EpatchObjectRefConsumer extends NonTerminalConsumer {
	...
	protected class CrossReference$8$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "leftRes", false, false, getElement(),
					getRuleCall$10$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$12$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(fragmentConsumer, "leftFrag", false, false, getElement(),
	...
	protected class CrossReference$16$Consumer extends ElementConsumer<CrossReference> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "leftRes", false, false, getElement(),
					getRuleCall$18$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$20$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(fragmentConsumer, "leftFrag", false, false, getElement(),
					getRuleCall$20$Delimiter(), optional);
		}
	}
	...
	protected class CrossReference$23$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "rightRes", false, false, getElement(),
	...
	protected class RuleCall$27$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(fragmentConsumer, "rightFrag", false, false, getElement(),
					getRuleCall$27$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$32$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(biSingleAssignmentConsumer, "assignments", true, false, false,
					getElement(), optional);
		}
	}
	...
	protected class RuleCall$34$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(biListAssignmentConsumer, "assignments", true, false, false,
					getElement(), optional);
		}
	}
	...
	public EpatchObjectRefConsumer(INonTerminalConsumerConfiguration configuration,
	...
	public void setRule(ObjectRefElements rule) {
		...
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule
		...
		crossReference$16$Consumer = new CrossReference$16$Consumer(rule
		...
		crossReference$23$Consumer = new CrossReference$23$Consumer(rule
		...
		ruleCall$32$Consumer = new RuleCall$32$Consumer(rule
		...
		ruleCall$34$Consumer = new RuleCall$34$Consumer(rule
