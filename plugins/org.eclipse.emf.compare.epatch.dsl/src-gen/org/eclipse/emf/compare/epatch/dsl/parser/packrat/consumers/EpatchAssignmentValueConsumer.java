...
public final class EpatchAssignmentValueConsumer extends NonTerminalConsumer {
	...
	public EpatchAssignmentValueConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(AssignmentValueElements rule) {
		...
		crossReference$22$Consumer = new CrossReference$22$Consumer(rule.getImportModelImportCrossReference_3_0_0());
