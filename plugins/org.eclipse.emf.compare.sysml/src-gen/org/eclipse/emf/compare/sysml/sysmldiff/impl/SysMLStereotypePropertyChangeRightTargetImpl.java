 ...
 * <em><b>Sys ML Stereotype Property Change Right Target</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.impl.SysMLStereotypePropertyChangeRightTargetImpl#getHideElements
 * <em>Hide Elements</em>}</li>
 * <li>
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.impl.SysMLStereotypePropertyChangeRightTargetImpl#isIsCollapsed
 * <em>Is Collapsed</em>}</li>
 * <li>
 * {@link org.eclipse.emf.compare.sysml.sysmldiff.impl.SysMLStereotypePropertyChangeRightTargetImpl#getStereotype
 * <em>Stereotype</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class SysMLStereotypePropertyChangeRightTargetImpl extends AttributeChangeRightTargetImpl implements SysMLStereotypePropertyChangeRightTarget {
	/**
	 ...
	 * @generated
	 */
	protected SysMLStereotypePropertyChangeRightTargetImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return SysMLdiffPackage.Literals.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET;
	}
	...
	public EList<DiffElement> getHideElements() {
		if (hideElements == null) {
			hideElements = new EObjectWithInverseResolvingEList.ManyInverse<DiffElement>(DiffElement.class,
					this, SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__HIDE_ELEMENTS,
	...
	public void setIsCollapsed(boolean newIsCollapsed) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__IS_COLLAPSED,
			...
			if (stereotype != oldStereotype) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__STEREOTYPE,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__HIDE_ELEMENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__STEREOTYPE:
				if (resolve)
		...
		if (baseClass == AbstractDiffExtension.class) {
			switch (baseFeatureID) {
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__HIDE_ELEMENTS:
					return SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__HIDE_ELEMENTS;
				case DiffPackage.ABSTRACT_DIFF_EXTENSION__IS_COLLAPSED:
					return SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__IS_COLLAPSED;
				default:
					return -1;
			}
		}
		...
		if (baseClass == UMLStereotypePropertyChange.class) {
			switch (baseFeatureID) {
				case UML2DiffPackage.UML_STEREOTYPE_PROPERTY_CHANGE__STEREOTYPE:
					return SysMLdiffPackage.SYS_ML_STEREOTYPE_PROPERTY_CHANGE_RIGHT_TARGET__STEREOTYPE;
				default:
					return -1;
			}
		}
...
} // SysMLStereotypePropertyChangeRightTargetImpl
