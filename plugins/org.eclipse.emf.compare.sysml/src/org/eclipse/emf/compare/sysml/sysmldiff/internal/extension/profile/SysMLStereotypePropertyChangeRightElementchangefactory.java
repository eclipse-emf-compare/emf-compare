...
/**
 * Factory for SysMLStereotypePropertyChangeRightElementchangefactory.
 * 
 * @author Arthur Daussy <a href="mailto:arthur.daussy@atos.net">arthur.daussy@atos.net</a>
 * @since 1.3
 */
public class SysMLStereotypePropertyChangeRightElementchangefactory extends UMLStereotypeAttributeChangeRightTargetFactory {
	/**
	 * Constructor.
	 * 
	 * @param engine
	 ...
	 */
	public SysMLStereotypePropertyChangeRightElementchangefactory(UML2DiffEngine engine) {
		super(engine);
	}
	...
	public boolean handles(DiffElement input) {
		if (input instanceof AttributeChange) {
			final boolean isSysML = Utils.belongToSysMLModel(((AttributeChange)input).getRightElement());
	...
	public AbstractDiffExtension create(DiffElement input, CrossReferencer crossReferencer) {
		...
		final SysMLStereotypePropertyChangeRightTarget ret = SysMLdiffFactory.eINSTANCE
				.createSysMLStereotypePropertyChangeRightTarget();
		...
		final UMLPredicate<Setting> pre = new UMLPredicate<EStructuralFeature.Setting>() {
			...
			public boolean apply(Setting input) {
				...
				if (eObject instanceof UMLStereotypeAttributeChangeRightTarget) {
					final UMLStereotypeAttributeChangeRightTarget diff = (UMLStereotypeAttributeChangeRightTarget)eObject;
