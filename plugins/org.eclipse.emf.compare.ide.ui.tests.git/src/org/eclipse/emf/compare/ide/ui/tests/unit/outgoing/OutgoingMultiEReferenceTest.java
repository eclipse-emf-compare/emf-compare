...
public class OutgoingMultiEReferenceTest extends LocalResolutionTest {
	...
	public OutgoingMultiEReferenceTest(CrossReferenceResolutionScope scopeToUse,
	...
	protected void setUpModel() throws Exception {
		...
		// Here we set the n-ary EReference from file1 to file2
