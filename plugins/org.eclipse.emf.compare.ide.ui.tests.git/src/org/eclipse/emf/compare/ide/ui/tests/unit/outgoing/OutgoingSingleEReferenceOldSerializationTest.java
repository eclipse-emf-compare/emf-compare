 ...
 * </pre>
 * 
 * The file for which the logical model is computed is "model.ecore". NOTE: This test differs from
 * {@link OutgoingSingleEReferenceTest} because the files read are serialized with an old version of EMF, with
...
public class OutgoingSingleEReferenceOldSerializationTest extends LocalResolutionTest {

	protected static final String FILE1_NAME = "model.ecore"; //$NON-NLS-1$

	protected static final String FILE2_NAME = "types.ecore"; //$NON-NLS-1$

	public OutgoingSingleEReferenceOldSerializationTest(CrossReferenceResolutionScope scopeToUse,
