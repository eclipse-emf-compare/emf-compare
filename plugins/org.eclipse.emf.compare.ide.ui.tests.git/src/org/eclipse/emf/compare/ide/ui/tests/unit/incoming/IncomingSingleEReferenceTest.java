 ...
 * 
 * <pre>
 * /project-2/file1.ecore
 * /project-2/file2.ecore -> n-ary EReference non-containment to file1.ecore
 * </pre>
 * 
...
public class IncomingSingleEReferenceTest extends LocalResolutionTest {
	...
	public IncomingSingleEReferenceTest(CrossReferenceResolutionScope scopeToUse,
	...
	protected void setUpModel() throws Exception {
		...
		// Here we set the 1-ary EReference from file2 to file1
		EReference ref = EcoreFactory.eINSTANCE.createEReference();
		ref.setName("refToC1"); //$NON-NLS-1$
		ref.setEType(c1);
		c2.getEStructuralFeatures().add(ref);
