...
public class IncomingMultiEReferenceTest extends LocalResolutionTest {
	...
	public IncomingMultiEReferenceTest(CrossReferenceResolutionScope scopeToUse,
	...
	protected void setUpModel() throws Exception {
		...
		// Here we set the n-ary EReference from file2 to file1
