...
public class EdgeMergeTest extends AbstractTest {
	...
	private static final int A2_DIFFS_NB = A2_EDGECHANGE_NB + A2_NODECHANGE_NB + A2_ASSOCHANGE_NB
			+ A2_CLASSCHANGE_NB;
	...
	private static final int A3_DIFFS_NB = A3_EDGECHANGE_NB + A3_NODECHANGE_NB + A3_ASSOCHANGE_NB
			+ A3_CLASSCHANGE_NB;
	...
	private static final int A4_DIFFS_NB = A4_EDGECHANGE_NB + A4_NODECHANGE_NB + A4_SUBNODECHANGE_NB
			+ A4_PROPNODECHANGE_NB + A4_PKGNODECHANGE_NB + A4_ASSOCHANGE_NB + A4_CLASSCHANGE_NB
			+ A4_PKGCHANGE_NB + A4_PROPCHANGE_NB;
	...
	private static final int A5_NOTMANAGED_MULTI_EDGES_NB = A5_NOTMANAGED_BRANCH_COMMON_NB
			+ A5_NOTMANAGED_BRANCHES_NB;
	...
	private static final int A5_DIFFS_NB = A5_NOTMANAGED_CONTAINMENT_LINK_NB + A5_NOTMANAGED_MULTI_EDGES_NB
			+ A5_NODECHANGES_NB + A5_EDGECHANGES_NB + A5_EDGECHANGE_ASSOS_NB + A5_EDGECHANGE_GENE1_NB
			+ A5_EDGECHANGE_IREAL_NB + A5_SEMANTIC_DIFFS_NB;
	...
	private static final int A6_DEPENDENCY_CHANGES_NB = 8 * A6_DEPENDENCY_CHANGE1_NB
			+ 2 * A6_SUBSTITUTION_CHANGE1_NB + A6_IREAL_CHANGE1_NB;
	...
	private static final int A6_DIFFS_NB = A6_NODECHANGES_NB + A6_DEPENDENCY_EDGE_CHANGES_NB
			+ A6_ASSO_EDGE_CHANGES_NB + A6_IMPORT_EDGE_CHANGES_NB + A6_FLOW_EDGE_CHANGES_NB
			+ A6_GENERAL_EDGE_CHANGES_NB + A6_CLASSCHANGES_NB + A6_DEPENDENCY_CHANGES_NB + A6_ASSO_CHANGES_NB
			+ A6_IMPORT_CHANGES_NB + A6_FLOW_CHANGES_NB + A6_GENERAL_CHANGES_NB;
	...
	private static final int A7_DIFFS_NB = A7_EDGECHANGES_NB + A7_EDGE_TARGET_CHANGE_NB
			+ A7_ASSO_TARGET_CHANGE_NB;
	...
	public void testA1b() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A1_DIFFS_NB - A1_EDGECHANGE_NB, new ExpectedStat(association, 1),
				new ExpectedStat(edge, 0)); // only graphical diffs merged
	}
	...
	public void testA2a() throws IOException {
		...
		diffsChecking(comparison, A2_DIFFS_NB, new ExpectedStat(association, 1), new ExpectedStat(edge, 1),
				new ExpectedStat(node, 1));
	...
	public void testA2b() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A2_DIFFS_NB - A2_EDGECHANGE_NB, new ExpectedStat(association, 1),
				new ExpectedStat(edge, 0), new ExpectedStat(node, 1));
	}
	...
	public void testA2e() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A2_DIFFS_NB - A2_ASSOCHANGE_NB - A2_CLASSCHANGE_NB,
				new ExpectedStat(association, 0), new ExpectedStat(edge, 1), new ExpectedStat(node, 1));
	}
	...
	public void testA2f() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A2_DIFFS_NB - A2_ASSOCHANGE_NB - A2_EDGECHANGE_NB,
				new ExpectedStat(association, 0), new ExpectedStat(edge, 0), new ExpectedStat(node, 1));
	}
	...
	public void testA3a() throws IOException {
		...
		Predicate<Diff> edge = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD));
		Predicate<Diff> node = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD));
		diffsChecking(comparison, A3_DIFFS_NB, new ExpectedStat(association, 1), new ExpectedStat(edge, 1),
				new ExpectedStat(node, 2));
	...
	public void testA3b() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A3_DIFFS_NB - A3_EDGECHANGE_NB, new ExpectedStat(association, 1),
				new ExpectedStat(edge, 0), new ExpectedStat(node, 2));
	}
	...
	@Test
	// Merge right to left <DELETE Edge> -> merge <ADD Nodes> (and merge <ADD Association>, merge <ADD
	// Classes>)
	...
	public void testA3e() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A3_DIFFS_NB - A3_ASSOCHANGE_NB - A3_CLASSCHANGE_NB,
				new ExpectedStat(association, 0), new ExpectedStat(edge, 1), new ExpectedStat(node, 2));
	}
	...
	public void testA3f() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A3_DIFFS_NB - A3_ASSOCHANGE_NB - A3_EDGECHANGE_NB,
				new ExpectedStat(association, 0), new ExpectedStat(edge, 0), new ExpectedStat(node, 2));
	}
	...
	@Test
	// Merge left to right <ADD Edge> -> merge <ADD Node>, merge <ADD PkgNode> (and merge <ADD Association>,
	// merge <ADD Class>, merge <ADD Package>)
	public void testA4a() throws IOException {
		...
		// ** DIFF CHECKING **
		Predicate<Diff> association = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.ADD));
		Predicate<Diff> edge1 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("a_b_1"));
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("c_b_1"));
		Predicate<Diff> node = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD));
		diffsChecking(comparison, A4_DIFFS_NB, new ExpectedStat(association, 2), new ExpectedStat(edge1, 1),
				new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
		...
		diffsChecking(comparison,
				A4_DIFFS_NB - A4_EDGECHANGE1_NB - A4_NODECHANGE1_NB - A4_PKGNODECHANGE_NB - A4_ASSOCHANGE1_NB
						- A4_CLASSCHANGE1_NB - A4_PKGCHANGE_NB,
				new ExpectedStat(association, 1), new ExpectedStat(edge1, 0), new ExpectedStat(edge2, 1),
				new ExpectedStat(node, 3));
	}
	...
	public void testA4b() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A4_DIFFS_NB - A4_EDGECHANGE1_NB, new ExpectedStat(association, 2),
				new ExpectedStat(edge1, 0), new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
	}
	...
	public void testA4c() throws IOException {
		...
		// ** DIFF CHECKING **
		Predicate<Diff> association = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.DELETE));
		Predicate<Diff> edge1 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.DELETE),
				elementNameIs("a_b_1"));
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.DELETE),
				elementNameIs("c_b_1"));
		Predicate<Diff> node = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.DELETE));
		diffsChecking(comparison, A4_DIFFS_NB, new ExpectedStat(association, 2), new ExpectedStat(edge1, 1),
				new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
	...
	@Test
	// Merge right to left <DELETE Edge> -> merge <ADD Node>, merge <ADD PkgNode> (and merge <ADD
	// Association>, merge <ADD Class>, merge <ADD Package>)
	...
	public void testA4e() throws IOException {
		...
		// ** DIFF CHECKING **
		Predicate<Diff> asso1 = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.ADD),
				nameIs("a_b_1"));
		Predicate<Diff> asso2 = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.ADD),
				nameIs("c_b_1"));
		Predicate<Diff> edge1 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("a_b_1"));
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("c_b_1"));
		Predicate<Diff> node = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD));
		diffsChecking(comparison, A4_DIFFS_NB, new ExpectedStat(asso1, 1), new ExpectedStat(asso2, 1),
				new ExpectedStat(edge1, 1), new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A4_DIFFS_NB - A4_ASSOCHANGE1_NB - A4_CLASSCHANGE1_NB - A4_PKGCHANGE_NB,
				new ExpectedStat(asso1, 0), new ExpectedStat(asso2, 1), new ExpectedStat(edge1, 1),
				new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
	}
	...
	public void testA4f() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A4_DIFFS_NB - A4_ASSOCHANGE1_NB - A4_EDGECHANGE1_NB,
				new ExpectedStat(asso1, 0), new ExpectedStat(asso2, 1), new ExpectedStat(edge1, 0),
				new ExpectedStat(edge2, 1), new ExpectedStat(node, 5));
	}
	...
	public void testA4g() throws IOException {
		...
		// ** DIFF CHECKING **
		Predicate<Diff> asso1 = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.DELETE),
				nameIs("a_b_1"));
		Predicate<Diff> asso2 = and(instanceOf(AssociationChange.class), ofKind(DifferenceKind.DELETE),
				nameIs("c_b_1"));
		Predicate<Diff> edge1 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.DELETE),
				elementNameIs("a_b_1"));
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.DELETE),
	...
	public void testA4i() throws IOException {
		...
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("c_b_1"));
		Predicate<Diff> nodeB = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("B"));
		Predicate<Diff> nodeSubB = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("SubB"));
		Predicate<Diff> nodePropB = and(instanceOf(NodeChange.class), ofKind(DifferenceKind.ADD),
				elementNameIs("propB"));
		diffsChecking(comparison, A4_DIFFS_NB, new ExpectedStat(asso1, 1), new ExpectedStat(asso2, 1),
				new ExpectedStat(edge1, 1), new ExpectedStat(edge2, 1), new ExpectedStat(nodeB, 1),
				new ExpectedStat(nodeSubB, 1), new ExpectedStat(nodePropB, 1));
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A4_DIFFS_NB - A4_NODECHANGE1_NB - A4_PKGNODECHANGE_NB - A4_CLASSCHANGE1_NB - A4_PKGCHANGE_NB,
				new ExpectedStat(asso1, 1), new ExpectedStat(asso2, 1), new ExpectedStat(edge1, 1),
				new ExpectedStat(edge2, 1), new ExpectedStat(nodeB, 0), new ExpectedStat(nodeSubB, 1),
				new ExpectedStat(nodePropB, 1));
	}

	@Test
	// Merge right to left <ADD NodeB> -> merge <ADD edge1>, merge <ADD edge2>, merge <ADD nodePropB>, merge
	// <ADD nodeSubB>
	public void testA4j() throws IOException {
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A4_DIFFS_NB - A4_NODECHANGE1_NB - 2 * A4_EDGECHANGE1_NB - A4_PROPNODECHANGE_NB
						- A4_SUBNODECHANGE_NB,
				new ExpectedStat(asso1, 1), new ExpectedStat(asso2, 1), new ExpectedStat(edge1, 0),
				new ExpectedStat(edge2, 0), new ExpectedStat(nodeB, 0), new ExpectedStat(nodeSubB, 0),
				new ExpectedStat(nodePropB, 0));
	}
	...
	public void testA6a() throws IOException {
		...
		// ** DIFF CHECKING **
		Predicate<Diff> substitutions = and(instanceOf(DirectedRelationshipChange.class),
				discriminantInstanceOf(UMLPackage.Literals.SUBSTITUTION), ofKind(DifferenceKind.ADD));
		Predicate<Diff> interfaceRealizations = and(instanceOf(DirectedRelationshipChange.class),
		...
		Predicate<Diff> dependencies = and(instanceOf(DirectedRelationshipChange.class),
				discriminantInstanceOf(UMLPackage.Literals.DEPENDENCY), ofKind(DifferenceKind.ADD));
		...
		Predicate<Diff> edgeAbstraction = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.ABSTRACTION));
		Predicate<Diff> edgeAssociation = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.ASSOCIATION));
		Predicate<Diff> edgeDependency = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.DEPENDENCY));
		Predicate<Diff> edgeImport = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.ELEMENT_IMPORT));
		Predicate<Diff> edgeGeneralization = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.GENERALIZATION));
		Predicate<Diff> edgeFlow = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.INFORMATION_FLOW));
		Predicate<Diff> edgeInterfaceRealization = and(instanceOf(EdgeChange.class),
				ofKind(DifferenceKind.ADD), elementClassIs(UMLPackage.Literals.INTERFACE_REALIZATION));
		Predicate<Diff> edgeRealization = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.REALIZATION));
		Predicate<Diff> edgeSubstitution = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.SUBSTITUTION));
		Predicate<Diff> edgeUsage = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.ADD),
				elementClassIs(UMLPackage.Literals.USAGE));

		diffsChecking(comparison, A6_DIFFS_NB, new ExpectedStat(substitutions, 2),
				new ExpectedStat(interfaceRealizations, 1), new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8), // 2
																										// abstractions
																										// + 2
																										// dependencies
																										// + 2
																										...
																										// Details
																										// below:
				new ExpectedStat(nodes, 2), new ExpectedStat(edges, 19), // 13 + 2 imports + 2 generalizations
																			// + 2 information flows (no
																			// UMLDiff for them). Details
																			// below:
				new ExpectedStat(edgeAbstraction, 2), new ExpectedStat(edgeAssociation, 2),
				new ExpectedStat(edgeDependency, 2), new ExpectedStat(edgeImport, 2),
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 2),
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 2),
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 2));
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_DEPENDENCY_EDGE_CHANGE1_NB - A6_DEPENDENCY_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 1),
				new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 7), // **
																										// -1
				new ExpectedStat(nodes, 1), // ** -1
				new ExpectedStat(edgeAbstraction, 1), // ** -1
				new ExpectedStat(edgeAssociation, 2), new ExpectedStat(edgeDependency, 2),
				new ExpectedStat(edgeImport, 2), new ExpectedStat(edgeGeneralization, 2),
				new ExpectedStat(edgeFlow, 2), new ExpectedStat(edgeInterfaceRealization, 1),
				new ExpectedStat(edgeRealization, 2), new ExpectedStat(edgeSubstitution, 2),
	...
	public void testA6b() throws IOException {
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_ASSO_EDGE_CHANGE1_NB - A6_ASSO_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 1),
				new ExpectedStat(associations, 1), // ** -1
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8),
				new ExpectedStat(nodes, 1), // ** -1
				new ExpectedStat(edgeAbstraction, 2), new ExpectedStat(edgeAssociation, 1), // ** -1
				new ExpectedStat(edgeDependency, 2), new ExpectedStat(edgeImport, 2),
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 2),
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 2),
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 2));
	...
	public void testA6d() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		// FIXME: ElementImport.importedElement is not merged => should create a UMLDiff for this
		// DirectedRelationship (A6_IMPORT_CHANGE1_NB += 1)
		// See Bug 406405
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_IMPORT_EDGE_CHANGE1_NB - A6_IMPORT_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 1),
				new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8),
				new ExpectedStat(nodes, 1), // ** -1
				new ExpectedStat(edgeAbstraction, 2), new ExpectedStat(edgeAssociation, 2),
				new ExpectedStat(edgeDependency, 2), new ExpectedStat(edgeImport, 1), // ** -1
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 2),
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 2),
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 2));
	}
	...
	public void testA6e() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		// FIXME: Generalization.general is not merged => should create a UMLDiff for this
		// DirectedRelationship (A6_GENERAL_CHANGE1_NB += 1)
		// See Bug 406405
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_GENERAL_EDGE_CHANGE1_NB - A6_GENERAL_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 1),
				new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8),
	...
	public void testA6f() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		// FIXME: InformationFlow.informationSource and InformationFlow.informationTarget are not merged =>
		// should create a UMLDiff for this DirectedRelationship (A6_FLOW_CHANGE1_NB += 2)
		// See Bug 406405
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_FLOW_EDGE_CHANGE1_NB - A6_FLOW_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 1),
				new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8),
				...
				new ExpectedStat(edgeAbstraction, 2), new ExpectedStat(edgeAssociation, 2),
				new ExpectedStat(edgeDependency, 2), new ExpectedStat(edgeImport, 2),
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 1), // ** -1
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 2),
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 2));
	}
	...
	public void testA6g() throws IOException {
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_DEPENDENCY_EDGE_CHANGE1_NB - A6_IREAL_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
				new ExpectedStat(substitutions, 2), new ExpectedStat(interfaceRealizations, 0), // ** -1
				new ExpectedStat(associations, 2),
				new ExpectedStat(and(dependencies, not(substitutions), not(interfaceRealizations)), 8),
				new ExpectedStat(nodes, 1), // ** -1
				new ExpectedStat(edgeAbstraction, 2), new ExpectedStat(edgeAssociation, 2),
	...
	public void testA6h() throws IOException {
		...
		diffsChecking(comparison,
				...
				new ExpectedStat(edgeDependency, 2), new ExpectedStat(edgeImport, 2),
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 2),
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 1), // ** -1
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 2));
	}
	...
	public void testA6i() throws IOException {
		...
		comparison = buildComparison(left, right);
		diffsChecking(comparison,
				A6_DIFFS_NB - A6_DEPENDENCY_EDGE_CHANGE1_NB - A6_SUBSTITUTION_CHANGE1_NB - A6_NODECHANGE1_NB
						- A6_CLASSCHANGE1_NB,
	...
	public void testA6j() throws IOException {
		...
		diffsChecking(comparison,
				...
				new ExpectedStat(edgeGeneralization, 2), new ExpectedStat(edgeFlow, 2),
				new ExpectedStat(edgeInterfaceRealization, 1), new ExpectedStat(edgeRealization, 2),
				new ExpectedStat(edgeSubstitution, 2), new ExpectedStat(edgeUsage, 1)); // ** -1
	}
	...
	public void testA7a() throws IOException {
		...
		Predicate<Diff> edge1 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.CHANGE),
				elementNameIs("a_b_1"));
		Predicate<Diff> edge2 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.CHANGE),
				elementNameIs("a_b_2"));
		Predicate<Diff> edge3 = and(instanceOf(EdgeChange.class), ofKind(DifferenceKind.CHANGE),
				elementNameIs("a_b_3"));
		Predicate<Diff> edgeTarget = and(instanceOf(ReferenceChange.class), ofKind(DifferenceKind.CHANGE),
				valueIs(NotationPackage.Literals.SHAPE));
		Predicate<Diff> assoTarget = and(instanceOf(ReferenceChange.class), ofKind(DifferenceKind.CHANGE),
				valueIs(UMLPackage.Literals.CLASS));

		diffsChecking(comparison, A7_DIFFS_NB, new ExpectedStat(edges, 3), new ExpectedStat(edgeTarget, 1),
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A7_DIFFS_NB - A7_EDGECHANGE1_NB, new ExpectedStat(edges, 2), // ** -1
				new ExpectedStat(edgeTarget, 1), new ExpectedStat(assoTarget, 1));
	}
	...
	public void testA7d() throws IOException {
		...
		// ** MERGE CHECKING **
		comparison = buildComparison(left, right);
		diffsChecking(comparison, A7_DIFFS_NB - A7_EDGE_TARGET_CHANGE_NB, new ExpectedStat(edges, 3),
