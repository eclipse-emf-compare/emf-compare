 ...
 *
 * $Id: IndepUpdateAttributeChangeItemProvider.java,v 1.1 2010/09/10 15:28:06 cbrun Exp $
 *******************************************************************************/
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.mpatch.IndepUpdateAttributeChange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndepUpdateAttributeChangeItemProvider
	extends IndepAttributeChangeItemProvider
	implements
	 ...
	 * @generated
	 */
	public IndepUpdateAttributeChangeItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns IndepUpdateAttributeChange.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public Object getImage(Object object) {
		...
		images.add(getResourceLocator().getImage("full/obj16/AttributeChange"));
	...
	public String getText(Object object) {
		final String feature = ((IndepUpdateAttributeChange)object).getChangedAttribute().getName();
		final String corresponding = MPatchUtil.formatSymrefLabel(((IndepUpdateAttributeChange)object).getCorrespondingElement());
		final String oldValue = MPatchUtil.formatValue(((IndepUpdateAttributeChange)object).getOldValue());
		final String newValue = MPatchUtil.formatValue(((IndepUpdateAttributeChange)object).getNewValue());
		
		return "Change attribute " + corresponding + "." + feature + " from \"" + oldValue + "\" to \"" + newValue + "\"";
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(IndepUpdateAttributeChange.class)) {
