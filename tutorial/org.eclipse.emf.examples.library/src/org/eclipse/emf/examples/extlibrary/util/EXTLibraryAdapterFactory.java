...
public class EXTLibraryAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Book
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Library
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Writer
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Item
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Lendable
	 ...
	 * {@link org.eclipse.emf.examples.extlibrary.CirculatingItem <em>Circulating Item</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Periodical
	 * <em>Periodical</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.examples.extlibrary.AudioVisualItem <em>Audio Visual Item</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.BookOnTape
	 * <em>Book On Tape</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.VideoCassette
	 * <em>Video Cassette</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we
	 * can easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Borrower
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Person
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Employee
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.examples.extlibrary.Addressable
	 * <em>Addressable</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
