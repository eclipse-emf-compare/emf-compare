...
public interface BookOnTape extends AudioVisualItem {
	/**
	 * Returns the value of the '<em><b>Reader</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.examples.extlibrary.BookOnTape#getReader <em>Reader</em>}
	...
	/**
	 * Returns the value of the '<em><b>Author</b></em>' reference. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.examples.extlibrary.BookOnTape#getAuthor <em>Author</em>}
	 * ' reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @param value
