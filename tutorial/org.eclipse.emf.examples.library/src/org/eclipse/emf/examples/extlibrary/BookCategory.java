...
public enum BookCategory implements Enumerator {
	...
	/**
	 * The '<em><b>Mystery</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #MYSTERY_LITERAL
	 * @model name="Mystery"
	 * @generated
	...
	/**
	 * The '<em><b>Science Fiction</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Biography</b></em>' literal value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
