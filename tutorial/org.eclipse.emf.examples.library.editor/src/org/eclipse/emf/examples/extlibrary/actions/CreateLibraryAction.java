...
/**
 * The extended library example supports multi-rooted resources and therefore this action allows the user to
 * create a library root on the resource.
 */
public class CreateLibraryAction extends StaticSelectionCommandAction {
	...
	/*
	 * @see
	 * org.eclipse.emf.edit.ui.action.StaticSelectionCommandAction#createActionCommand(org.eclipse.emf.edit.
	 * domain.EditingDomain, java.util.Collection)
	 */
	@Override
	protected Command createActionCommand(EditingDomain inputEditingDomain, Collection<?> collection) {

		return new AddLibraryCommand(inputEditingDomain, ((Resource)collection.toArray()[0]).getContents(),
