 ...
 *******************************************************************************/
package org.eclipse.emf.compare.mpatch.common;
 ...
 *
 */
public class CommonMPatchPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "org.eclipse.emf.compare.mpatch";

	// The shared instance
	private static CommonMPatchPlugin plugin;
	 ...
	 */
	public static CommonMPatchPlugin getDefault() {
		return plugin;
	}
	...
	public void logWarning(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.WARNING, PLUGIN_ID, IStatus.WARNING, message, throwable));
		debug(message, throwable);
	}
