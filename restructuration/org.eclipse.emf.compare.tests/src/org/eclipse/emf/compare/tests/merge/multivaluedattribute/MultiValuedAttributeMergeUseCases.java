...
import org.eclipse.emf.compare.tests.merge.multivaluedattribute.data.MergeMMMultiValuedAttributeInputData;

public class MultiValuedAttributeMergeUseCases extends MergeTestBase {
	MergeMMMultiValuedAttributeInputData input = new MergeMMMultiValuedAttributeInputData();

	public void testUseCase109() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase109());
	}

	public void testReverseUseCase109() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase109());
	}

	public void testUseCase110() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase110());
	}

	public void testReverseUseCase110() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase110());
	}

	public void testUseCase111() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase111());
	}

	public void testReverseUseCase111() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase111());
	}

	public void testUseCase112() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase112());
	}

	public void testReverseUseCase112() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase112());
	}

	public void testUseCase113() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase113());
	}

	public void testReverseUseCase113() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase113());
	}

	public void testUseCase114() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase114());
	}

	public void testReverseUseCase114() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase114());
	}

	public void testUseCase115() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase115());
	}

	public void testReverseUseCase115() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase115());
	}

	public void testUseCase116() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase116());
	}

	public void testReverseUseCase116() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase116());
	}

	public void testUseCase117() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase117());
	}

	public void testReverseUseCase117() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase117());
	}

	public void testUseCase118() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase118());
	}

	public void testReverseUseCase118() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase118());
	}

	public void testUseCase119() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase119());
	}

	public void testReverseUseCase119() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase119());
	}

	public void testUseCase120() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase120());
	}

	public void testReverseUseCase120() throws Exception {
		mergeAllDiffsRightToLeft(input.getBase(), input.getUseCase120());
	}

	public void testUseCase121() throws Exception {
		mergeAllDiffsLeftToRight(input.getBase(), input.getUseCase121());
	}
