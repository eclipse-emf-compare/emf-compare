...
/**
 * <!-- begin-user-doc --> A representation of the model object '<em><b>People</b></em>'. <!-- end-user-doc
 * -->
 * <p>
...
public interface People extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.compare.examples.addressbook.addressbook.People#getName
	...
	/**
	 * Returns the value of the '<em><b>Contacts</b></em>' containment reference list. The list contents are
	 * of type {@link org.eclipse.emf.compare.examples.addressbook.addressbook.Contact}. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of the '<em>Contacts</em>' containment reference list isn't clear, there really should
