...
public class AddressbookSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AddressbookPackage.ELECTRONIC: {
				final Electronic electronic = (Electronic)theEObject;
				T result = caseElectronic(electronic);
				if (result == null) {
					result = caseContact(electronic);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case AddressbookPackage.OFFICE: {
				final Office office = (Office)theEObject;
				T result = caseOffice(office);
				if (result == null) {
					result = caseContact(office);
				}
				if (result == null) {
					result = defaultCase(theEObject);
				}
			...
			case AddressbookPackage.PEOPLE: {
				final People people = (People)theEObject;
			...
			case AddressbookPackage.ADDRESS_BOOK: {
				final AddressBook addressBook = (AddressBook)theEObject;
			...
			case AddressbookPackage.BOOK_VERSION: {
				final BookVersion bookVersion = (BookVersion)theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Contact</em>'. <!-- begin-user-doc
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Office</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>People</em>'. <!-- begin-user-doc
	 * --> This implementation returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
