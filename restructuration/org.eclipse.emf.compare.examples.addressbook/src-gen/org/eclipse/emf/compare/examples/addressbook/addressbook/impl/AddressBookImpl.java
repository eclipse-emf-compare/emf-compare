...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Address Book</b></em>'. <!--
 * end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.emf.compare.examples.addressbook.addressbook.impl.AddressBookImpl#getPeoples <em>
 * Peoples</em>}</li>
 * </ul>
 * </p>
 * 
...
public class AddressBookImpl extends EObjectImpl implements AddressBook {
	...
	public EList<People> getPeoples() {
		if (peoples == null) {
			peoples = new EObjectContainmentEList<People>(People.class, this,
					AddressbookPackage.ADDRESS_BOOK__PEOPLES);
		}
		return peoples;
	}
