...
/**
 * This is the action bar contributor for the Library model editor. <!-- begin-user-doc --> <!-- end-user-doc
 * -->
 * 
 * @generated
 */
public class LibraryActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(LibraryEditPlugin.INSTANCE
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(LibraryEditPlugin.INSTANCE
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		final IMenuManager submenuManager = new MenuManager(LibraryEditPlugin.INSTANCE
				.getString("_UI_LibraryEditor_menu"), "org.eclipse.emf.compare.examples.export.libraryMenuID"); //$NON-NLS-1$ //$NON-NLS-2$
		...
		//
		createChildMenuManager = new MenuManager(LibraryEditPlugin.INSTANCE
				.getString("_UI_CreateChild_menu_item")); //$NON-NLS-1$
		submenuManager.insertBefore("additions", createChildMenuManager); //$NON-NLS-1$

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(LibraryEditPlugin.INSTANCE
