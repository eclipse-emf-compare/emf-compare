...
/**
 * Tests the behavior of the {@link FastMap}'s entrySet and its iterator so that they behave the same as
...
public class TestEntrySet extends TestCase {
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set is expected to support the clear() operation and it
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set's iterator is expected to throw a
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set is expected not to support the add() operation.
	 */
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set is expected to support the removeAll(Collection)
	...
	/**
	 * Tests the {@link FastMap}'s entry set's iterator. The iterator is expected to support the
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set is expected to support the remove(Object) operation and
	...
	/**
	 * Tests the {@link FastMap}'s entry set. The set is expected to support the retainAll(Collection)
	...
	/**
	 * Tests the creation of the {@link FastMap}'s entry set.
	 * <p>
	 * <ul>
	 * Assertions :
