 ...
 * </copyright>
 *
 * $Id: RepositoryImpl.java,v 1.1 2008/04/11 14:56:46 cbrun Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.compare.examples.addressbook.addressbook.impl.RepositoryImpl#getHead <em>Head</em>}</li>
 *   <li>{@link org.eclipse.emf.compare.examples.addressbook.addressbook.impl.RepositoryImpl#getHistory <em>History</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RepositoryImpl extends EObjectImpl implements Repository {
    ...
    public NotificationChain basicSetHead(AddressBook newHead, NotificationChain msgs) {
        AddressBook oldHead = head;
        head = newHead;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AddressbookPackage.REPOSITORY__HEAD, oldHead, newHead);
    ...
    public void setHead(AddressBook newHead) {
        if (newHead != head) {
            ...
            if (head != null)
                msgs = ((InternalEObject)head).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.REPOSITORY__HEAD, null, msgs);
            if (newHead != null)
                msgs = ((InternalEObject)newHead).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AddressbookPackage.REPOSITORY__HEAD, null, msgs);
            msgs = basicSetHead(newHead, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, AddressbookPackage.REPOSITORY__HEAD, newHead, newHead));
    }
    ...
    public EList<BookVersion> getHistory() {
        if (history == null) {
            history = new EObjectContainmentEList<BookVersion>(BookVersion.class, this, AddressbookPackage.REPOSITORY__HISTORY);
        }
        return history;
    }
