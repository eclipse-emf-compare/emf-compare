 ...
 * </copyright>
 *
 * $Id: MemberItemProvider.java,v 1.1 2008/04/21 09:43:18 lgoubet Exp $
 */
...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.compare.examples.export.library.Member} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemberItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.MEMBER__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LibraryPackage.Literals.MEMBER__ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Borrowed Books feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Member_borrowedBooks_feature", "_UI_Member_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
				 LibraryPackage.Literals.MEMBER__BORROWED_BOOKS,
				 true,
				 false,
				 true,
				 null,
