 ...
 * 
 *
 * $Id: DiffExtensionFactoryImpl.java,v 1.2 2007/12/04 13:14:50 lgoubet Exp $
 */
...
public class DiffExtensionFactoryImpl extends EFactoryImpl implements DiffExtensionFactory {
	...
	public static DiffExtensionFactory init() {
		try {
			DiffExtensionFactory theDiffExtensionFactory = (DiffExtensionFactory)EPackage.Registry.INSTANCE
					.getEFactory("http://www.eclipse.org/emf/compare/sample/diff_extension/1.0");
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DiffExtensionPackage.ADD_UML_ASSOCIATION:
				return createAddUMLAssociation();
			default:
