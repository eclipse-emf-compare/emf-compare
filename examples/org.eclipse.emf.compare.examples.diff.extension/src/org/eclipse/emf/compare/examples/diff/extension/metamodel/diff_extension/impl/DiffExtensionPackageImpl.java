 ...
 * 
 *
 * $Id: DiffExtensionPackageImpl.java,v 1.2 2007/12/04 13:14:50 lgoubet Exp $
 */
...
public class DiffExtensionPackageImpl extends EPackageImpl implements DiffExtensionPackage {
	...
	public static DiffExtensionPackage init() {
		if (isInited)
			return (DiffExtensionPackage)EPackage.Registry.INSTANCE.getEPackage(DiffExtensionPackage.eNS_URI);

		// Obtain or create and register package
		DiffExtensionPackageImpl theDiffExtensionPackage = (DiffExtensionPackageImpl)(EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof DiffExtensionPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) : new DiffExtensionPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(addUMLAssociationEClass, AddUMLAssociation.class, "AddUMLAssociation", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(umlAssociationDiffEClass, UMLAssociationDiff.class, "UMLAssociationDiff", IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getUMLAssociationDiff_Properties(), ecorePackage.getEObject(), null, "properties",
				null, 1, -1, UMLAssociationDiff.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUMLAssociationDiff_IsNavigable(), theEcorePackage.getEBoolean(), "isNavigable",
				"false", 0, 1, UMLAssociationDiff.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getUMLAssociationDiff_ContainerPackage(), ecorePackage.getEObject(), null,
				"containerPackage", null, 1, 1, UMLAssociationDiff.class, !IS_TRANSIENT, !IS_VOLATILE,
