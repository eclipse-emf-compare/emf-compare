 ...
 * 
 *
 * $Id: DiffExtensionPackage.java,v 1.2 2007/12/04 13:14:50 lgoubet Exp $
 */
...
public interface DiffExtensionPackage extends EPackage {
	 ...
	 * @generated
	 */
	DiffExtensionPackage eINSTANCE = org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.DiffExtensionPackageImpl
			.init();
	...
	/**
	 * The meta object id for the '{@link org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.UMLAssociationDiffImpl <em>UML Association Diff</em>}'
	...
	/**
	 * The feature id for the '<em><b>Container Package</b></em>' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Is Navigable</b></em>' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The number of structural features of the '<em>UML Association Diff</em>' class. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the '{@link org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.AddUMLAssociationImpl <em>Add UML Association</em>}'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	int ADD_UML_ASSOCIATION__LEFT_PARENT = UML_ASSOCIATION_DIFF_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int ADD_UML_ASSOCIATION__RIGHT_ELEMENT = UML_ASSOCIATION_DIFF_FEATURE_COUNT + 3;
	...
	/**
	 * The number of structural features of the '<em>Add UML Association</em>' class. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ADD_UML_ASSOCIATION_FEATURE_COUNT = UML_ASSOCIATION_DIFF_FEATURE_COUNT + 4;
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.AddUMLAssociationImpl <em>Add UML Association</em>}'
		 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.AddUMLAssociationImpl
		 * @see org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.DiffExtensionPackageImpl#getAddUMLAssociation()
		...
		/**
		 * The meta object literal for the '{@link org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.UMLAssociationDiffImpl <em>UML Association Diff</em>}'
		 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.UMLAssociationDiffImpl
		 * @see org.eclipse.emf.compare.examples.diff.extension.metamodel.diff_extension.impl.DiffExtensionPackageImpl#getUMLAssociationDiff()
		 ...
		 * @generated
		 */
		EReference UML_ASSOCIATION_DIFF__CONTAINER_PACKAGE = eINSTANCE
				.getUMLAssociationDiff_ContainerPackage();
