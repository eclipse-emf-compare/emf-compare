 ...
 * @generated
 */
public class Diff_extensionSwitch {
	/**
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Diff_extensionPackage.RENAME_MODEL_ELEMENT: {
				RenameModelElement renameModelElement = (RenameModelElement)theEObject;
				Object result = caseRenameModelElement(renameModelElement);
				if (result == null) result = caseUpdateAttribute(renameModelElement);
				if (result == null) result = caseAttributeChange(renameModelElement);
				if (result == null) result = caseDiffElement(renameModelElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Diff_extensionPackage.MOVE_MODEL_ELEMENT: {
	...
	/**
	 * Returns the result of interpretting the object as an instance of '<em>Rename Model Element</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpretting the object as an instance of '<em>Rename Model Element</em>'.
